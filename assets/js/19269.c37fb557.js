...
`;class V extends g{focusDistance;focusRange;constructor(e,t,r){super(e),this.cameraComponent=t,T.W.get(e,"glsl").set("cocPS",z),T.W.get(e,"wgsl").set("cocPS",M);let s=new Map;r&&s.set("NEAR_BLUR",""),x.lo.addScreenDepthChunkDefines(t.shaderParams,s),this.shader=x.lo.createShader(e,{uniqueName:`CocShader-${r}`,attributes:{aPosition:d.JY},vertexChunk:"quadVS",fragmentChunk:"cocPS",fragmentDefines:s}),this.paramsId=e.scope.resolve("params"),this.paramsValue=new Float32Array(3),this.cameraParams=new Float32Array(4),this.cameraParamsId=e.scope.resolve("camera_params")}execute(){let{paramsValue:e,focusRange:t}=this;e[0]=this.focusDistance+.001,e[1]=t,e[2]=1/t,this.paramsId.setValue(e);let r=this.cameraComponent.camera;this.cameraParamsId.setValue(r.fillShaderParams(this.cameraParams)),super.execute()}}class B{static concentric(e,t){let r=[];r.push(0,0);let s=2*Math.PI/e/t;for(let t=1;t<=e;t++){let a=t/e,o=Math.max(1,Math.floor(2*Math.PI*a/s)),i=2*Math.PI/o;for(let e=0;e<o;e++){let t=e*i,s=a*Math.cos(t),o=a*Math.sin(t);r.push(s,o)}}return r}}var N=`
...
`;class W extends g{blurRadiusNear=1;blurRadiusFar=1;_blurRings=3;_blurRingPoints=3;referenceHeight=540;constructor(e,t,r,s){super(e),this.nearTexture=t,this.farTexture=r,this.cocTexture=s,T.W.get(e,"glsl").set("dofBlurPS",N),T.W.get(e,"wgsl").set("dofBlurPS",k);let{scope:a}=e;this.kernelId=a.resolve("kernel[0]"),this.kernelCountId=a.resolve("kernelCount"),this.blurRadiusNearId=a.resolve("blurRadiusNear"),this.blurRadiusFarId=a.resolve("blurRadiusFar"),this.nearTextureId=a.resolve("nearTexture"),this.farTextureId=a.resolve("farTexture"),this.cocTextureId=a.resolve("cocTexture")}set blurRings(e){this._blurRings!==e&&(this._blurRings=e,this.shader=null)}get blurRings(){return this._blurRings}set blurRingPoints(e){this._blurRingPoints!==e&&(this._blurRingPoints=e,this.shader=null)}get blurRingPoints(){return this._blurRingPoints}createShader(){this.kernel=new Float32Array(B.concentric(this.blurRings,this.blurRingPoints));let e=this.kernel.length>>1,t=null!==this.nearTexture,r=new Map;r.set("{KERNEL_COUNT}",e),r.set("{INV_KERNEL_COUNT}",1/e),t&&r.set("NEAR_BLUR",""),this.shader=x.lo.createShader(this.device,{uniqueName:`DofBlurShader-${e}-${t?"nearBlur":"noNearBlur"}`,attributes:{aPosition:d.JY},vertexChunk:"quadVS",fragmentChunk:"dofBlurPS",fragmentDefines:r})}execute(){this.shader||this.createShader(),this.nearTextureId.setValue(this.nearTexture),this.farTextureId.setValue(this.farTexture),this.cocTextureId.setValue(this.cocTexture),this.kernelId.setValue(this.kernel),this.kernelCountId.setValue(this.kernel.length>>1);let e=1/(this.referenceHeight>0?this.referenceHeight:540);this.blurRadiusNearId.setValue(this.blurRadiusNear*e),this.blurRadiusFarId.setValue(this.blurRadiusFar*e),super.execute()}}class H extends l.B{focusDistance=100;focusRange=50;blurRadius=1;blurRings=3;blurRingPoints=3;highQuality=!0;cocTexture=null;blurTexture=null;cocPass=null;farPass=null;blurPass=null;constructor(e,t,r,s,a,o){super(e),this.highQuality=a,this.cocPass=this.setupCocPass(e,t,r,o),this.beforePasses.push(this.cocPass);let i=a?r:s;this.farPass=this.setupFarPass(e,i,.5),this.beforePasses.push(this.farPass),this.blurPass=this.setupBlurPass(e,s,o,a?2:.5),this.beforePasses.push(this.blurPass)}destroy(){this.destroyRenderPasses(),this.cocPass=null,this.farPass=null,this.blurPass=null,this.destroyRT(this.cocRT),this.destroyRT(this.farRt),this.destroyRT(this.blurRt),this.cocRT=null,this.farRt=null,this.blurRt=null}destroyRenderPasses(){for(let e=0;e<this.beforePasses.length;e++)this.beforePasses[e].destroy();this.beforePasses.length=0}destroyRT(e){e&&(e.destroyTextureBuffers(),e.destroy())}setupCocPass(e,t,r,a){this.cocRT=this.createRenderTarget("CoCTexture",a?53:52),this.cocTexture=this.cocRT.colorBuffer;let o=new V(e,t,a);return o.init(this.cocRT,{resizeSource:r}),o.setClearColor(s.Q.BLACK),o}setupFarPass(e,t,r){this.farRt=this.createRenderTarget("FarDofTexture",t.format);let a=new b(e,t,{boxFilter:!0,premultiplyTexture:this.cocTexture,premultiplySrcChannel:"r"});return a.init(this.farRt,{resizeSource:t,scaleX:r,scaleY:r}),a.setClearColor(s.Q.BLACK),a}setupBlurPass(e,t,r,a){let o=this.farRt?.colorBuffer;this.blurRt=this.createRenderTarget("DofBlurTexture",t.format),this.blurTexture=this.blurRt.colorBuffer;let i=new W(e,r?t:null,o,this.cocTexture);return i.init(this.blurRt,{resizeSource:t,scaleX:a,scaleY:a}),i.setClearColor(s.Q.BLACK),i}createTexture(e,t){return new n.g(this.device,{name:e,width:1,height:1,format:t,mipmaps:!1,minFilter:1,magFilter:1,addressU:1,addressV:1})}createRenderTarget(e,t){return new h.O({colorBuffer:this.createTexture(e,t),depth:!1,stencil:!1})}frameUpdate(){super.frameUpdate(),this.cocPass.focusDistance=this.focusDistance,this.cocPass.focusRange=this.focusRange,this.blurPass.blurRadiusNear=this.blurRadius,this.blurPass.blurRadiusFar=this.blurRadius,this.blurPass.blurRings=this.blurRings,this.blurPass.blurRingPoints=this.blurRingPoints}}var G=r(93953),j=`
	#include "screenDepthPS"
	varying vec2 uv0;
...
`;let Q=new G.e;class Y extends g{light=null;shadowsEnabled=!1;lightRenderData=null;tint=new s.Q(1,1,1);density=.01;heightBase=0;heightFalloff=.05;anisotropy=.6;intensity=1;ambientColor=new s.Q(1,1,1);ambientIntensity=.02;maxDistance=300;steps=24;noiseOffset=0;exposure=1;_variantKey=null;constructor(e,t){super(e),this.cameraComponent=t;let r=e.scope;this.cameraPosId=r.resolve("uFogCameraPos"),this.cameraFwdId=r.resolve("uFogCameraFwd"),this.invViewId=r.resolve("uFogInvView"),this.projScaleId=r.resolve("uFogProjScale"),this.tintId=r.resolve("uFogTint"),this.lightColorId=r.resolve("uFogLightColor"),this.lightDirId=r.resolve("uFogLightDir"),this.ambientId=r.resolve("uFogAmbient"),this.fogParamsId=r.resolve("uFogParams"),this.scatterParamsId=r.resolve("uFogScatterParams"),this.shadowMapId=r.resolve("uFogShadowMap"),this.shadowMatrixPaletteId=r.resolve("uFogShadowMatrixPalette[0]"),this.shadowCascadeDistancesId=r.resolve("uFogShadowCascadeDistances"),this.shadowParamsId=r.resolve("uFogShadowParams"),this._cameraPos=new Float32Array(3),this._cameraFwd=new Float32Array(3),this._projScale=new Float32Array(2),this._tint=new Float32Array(3),this._lightColor=new Float32Array(3),this._lightDir=new Float32Array(3),this._ambient=new Float32Array(3),this._fogParams=new Float32Array(4),this._scatterParams=new Float32Array(4),this._shadowParams=new Float32Array(4)}updateShaderVariant(e,t){let r=this.cameraComponent.shaderParams.sceneDepthMapLinear,s=`${e}-${t}-${r}`;if(this._variantKey!==s){this._variantKey=s;let r=new Map;x.lo.addScreenDepthChunkDefines(this.cameraComponent.shaderParams,r),e&&r.set("FOG_SHADOWS",""),t&&r.set("FOG_SHADOW_PCF",""),this.shader=x.lo.createShader(this.device,{uniqueName:`VolumetricFogShader-${s}`,attributes:{aPosition:d.JY},vertexChunk:"quadVS",fragmentChunk:"volumetricFogPS",fragmentDefines:r})}}execute(){let{light:e}=this,t=this.cameraComponent.camera,r=t._node;this.invViewId.setValue(r.getWorldTransform().data);let s=r.getPosition();this._cameraPos[0]=s.x,this._cameraPos[1]=s.y,this._cameraPos[2]=s.z,this.cameraPosId.setValue(this._cameraPos);let a=r.forward;this._cameraFwd[0]=a.x,this._cameraFwd[1]=a.y,this._cameraFwd[2]=a.z,this.cameraFwdId.setValue(this._cameraFwd);let o=t.projectionMatrix.data;this._projScale[0]=1/o[0],this._projScale[1]=1/o[5],this.projScaleId.setValue(this._projScale);let i=this.intensity*this.exposure;if(e){e._node.getWorldTransform().getY(Q).normalize(),this._lightDir[0]=Q.x,this._lightDir[1]=Q.y,this._lightDir[2]=Q.z;let t=e._colorLinear;this._lightColor[0]=t[0]*i,this._lightColor[1]=t[1]*i,this._lightColor[2]=t[2]*i}else this._lightDir[0]=0,this._lightDir[1]=1,this._lightDir[2]=0,this._lightColor[0]=0,this._lightColor[1]=0,this._lightColor[2]=0;if(this.lightDirId.setValue(this._lightDir),this.lightColorId.setValue(this._lightColor),this.shadowsEnabled&&e&&this.lightRenderData){let t=this.lightRenderData,r=e._getUniformBiasValues(t);this.shadowMapId.setValue(t.shadowBuffer),this.shadowMatrixPaletteId.setValue(e._shadowMatrixPalette),this.shadowCascadeDistancesId.setValue(e._shadowCascadeDistances),this._shadowParams[0]=e.numCascades,this._shadowParams[1]=r.bias,this._shadowParams[2]=0,this._shadowParams[3]=e.shadowDistance,this.shadowParamsId.setValue(this._shadowParams)}let{tint:n,ambientColor:l,ambientIntensity:u}=this;this._tint[0]=n.r,this._tint[1]=n.g,this._tint[2]=n.b,this.tintId.setValue(this._tint);let c=u*this.exposure;this._ambient[0]=l.r*c,this._ambient[1]=l.g*c,this._ambient[2]=l.b*c,this.ambientId.setValue(this._ambient),this._fogParams[0]=this.density,this._fogParams[1]=this.heightBase,this._fogParams[2]=this.heightFalloff,this._fogParams[3]=this.maxDistance,this.fogParamsId.setValue(this._fogParams),this._scatterParams[0]=this.anisotropy,this._scatterParams[1]=this.steps,this._scatterParams[2]=this.noiseOffset,this._scatterParams[3]=e?e.shadowIntensity:1,this.scatterParamsId.setValue(this._scatterParams),super.execute()}}class Z extends g{constructor(e,t,r){super(e),this.fogTexture=r;let s=new Map;x.lo.addScreenDepthChunkDefines(t.shaderParams,s),this.shader=x.lo.createShader(e,{uniqueName:`VolumetricFogCombineShader-${t.shaderParams.sceneDepthMapLinear}`,attributes:{aPosition:d.JY},vertexChunk:"quadVS",fragmentChunk:"volumetricFogCombinePS",fragmentDefines:s}),this.blendState=new f.t(!0,0,1,6,0,0,1),this.fogTextureId=e.scope.resolve("uFogTexture"),this.fogTextureSizeId=e.scope.resolve("uFogTextureSize"),this._fogTextureSize=new Float32Array(4)}execute(){let{fogTexture:e}=this;this.fogTextureId.setValue(e),this._fogTextureSize[0]=e.width,this._fogTextureSize[1]=e.height,this._fogTextureSize[2]=1/e.width,this._fogTextureSize[3]=1/e.height,this.fogTextureSizeId.setValue(this._fogTextureSize),super.execute()}}class K extends l.B{light=null;tint=new s.Q(1,1,1);density=.01;heightBase=0;heightFalloff=.05;anisotropy=.6;intensity=1;ambientColor=new s.Q(1,1,1);ambientIntensity=.02;maxDistance=300;steps=24;temporalDither=!1;_scale=.5;_frameIndex=0;constructor(e,t,r,a){super(e),this.cameraComponent=t,T.W.get(e,"glsl").set("volumetricFogPS",j),T.W.get(e,"wgsl").set("volumetricFogPS",X),T.W.get(e,"glsl").set("volumetricFogCombinePS",$),T.W.get(e,"wgsl").set("volumetricFogCombinePS",q);let o=e.getRenderableHdrFormat([12,14],!0,1)??7;this.fogTexture=new n.g(e,{name:"VolumetricFogTexture",width:4,height:4,format:o,mipmaps:!1,minFilter:1,magFilter:1,addressU:1,addressV:1}),this.fogRenderTarget=new h.O({name:"VolumetricFogRT",colorBuffer:this.fogTexture,depth:!1}),this.fogPass=new Y(e,t),this.fogPass.init(this.fogRenderTarget,{resizeSource:r,scaleX:this._scale,scaleY:this._scale}),this.fogPass.setClearColor(new s.Q(0,0,0,1)),this.beforePasses.push(this.fogPass),this.combinePass=new Z(e,t,this.fogTexture),this.combinePass.init(a),this.beforePasses.push(this.combinePass)}destroy(){this.beforePasses.forEach(e=>e.destroy()),this.beforePasses.length=0,this.fogPass=null,this.combinePass=null,this.fogRenderTarget&&(this.fogRenderTarget.destroyTextureBuffers(),this.fogRenderTarget.destroy(),this.fogRenderTarget=null,this.fogTexture=null)}set scale(e){this._scale=e,this.fogPass.scaleX=e,this.fogPass.scaleY=e}get scale(){return this._scale}frameUpdate(){super.frameUpdate();let{light:e,fogPass:t}=this,r=this.cameraComponent.camera,s=!1,a=!1,o=null;e&&e.castShadows&&e.shadowIntensity>0&&(o=e.getRenderData(r,0)).shadowBuffer&&(s=!0,a=!!i.$Tp.get(e._shadowType)?.pcf),t.updateShaderVariant(s,a),t.shadowsEnabled=s,t.lightRenderData=s?o:null,t.light=e,t.tint.copy(this.tint),t.density=this.density,t.heightBase=this.heightBase,t.heightFalloff=this.heightFalloff,t.anisotropy=this.anisotropy,t.intensity=this.intensity,t.ambientColor.copy(this.ambientColor),t.ambientIntensity=this.ambientIntensity,t.maxDistance=this.maxDistance,t.steps=Math.max(1,Math.floor(this.steps)),t.exposure=this.cameraComponent.system.app.scene.exposure,this._frameIndex=(this._frameIndex+1)%16,t.noiseOffset=this.temporalDither?.618034*this._frameIndex:0}}var J=r(33984);let ee=[];class et extends p.A{linearDepthTexture;linearDepthClearValue=new s.Q(0,0,0,0);_qualifiedLayerIndices=[];constructor(e,t,r,s,a){super(e),this.scene=t,this.renderer=r,this.camera=s,this.setupRenderTarget(a)}destroy(){super.destroy(),this.camera.shaderParams.sceneDepthMapLinear=!1,this.renderTarget?.destroy(),this.renderTarget=null,this.linearDepthTexture?.destroy(),this.linearDepthTexture=null}setupRenderTarget(e){let{device:t}=this;this.linearDepthFormat=t.textureFloatRenderable?15:7,this.linearDepthTexture=n.g.createDataTexture2D(t,"SceneLinearDepthTexture",1,1,this.linearDepthFormat);let r=new h.O({name:"PrepassRT",colorBuffer:this.linearDepthTexture,depth:!0,samples:1});this.camera.shaderParams.sceneDepthMapLinear=!0,this.init(r,e)}after(){this.device.scope.resolve("uSceneDepthMap").setValue(this.linearDepthTexture)}execute(){let{renderer:e,scene:t,renderTarget:r}=this,s=this.camera.camera,a=t.layers.layerList,o=t.layers.subLayerList;for(let t of this._qualifiedLayerIndices){let n=a[t].getCulledInstances(s),l=o[t]?n.transparent:n.opaque;for(let e=0;e<l.length;e++){let t=l[e];t.material?.depthWrite&&ee.push(t)}e.renderForwardLayer(s,r,null,void 0,i.pP7,{meshInstances:ee}),ee.length=0}}frameUpdate(){let e;super.frameUpdate();let{camera:t}=this;if(this.setClearDepth(t.clearDepthBuffer?1:void 0),t.clearDepthBuffer){let r=t.farClip-5e-324;e=this.linearDepthClearValue,15===this.linearDepthFormat?e.r=r:J.A.float2RGBA8(r,e)}this.setClearColor(e);let{renderer:r,scene:s}=this,a=this.camera.camera,o=s.layers,n=o.layerList,l=this._qualifiedLayerIndices;l.length=0;for(let e=0;e<n.length&&n[e].id!==i.$9T;e++)o.isSubLayerRenderedByCamera(e,a)&&(l.push(e),r.culler.requestMeshInstanceCull(a,n[e]))}}var er=r(60017),es=`
	#include "screenDepthPS"
	varying vec2 uv0;
	uniform sampler2D sourceTexture;
	uniform vec2 sourceInvResolution;
...
`;class eo extends g{constructor(e,t,r,s){super(e),this.sourceTexture=t,T.W.get(e,"glsl").set("depthAwareBlurPS",es),T.W.get(e,"wgsl").set("depthAwareBlurPS",ea);let a=new Map;s&&a.set("HORIZONTAL",""),x.lo.addScreenDepthChunkDefines(r.shaderParams,a),this.shader=x.lo.createShader(e,{uniqueName:`DepthAware${s?"Horizontal":"Vertical"}BlurShader`,attributes:{aPosition:d.JY},vertexChunk:"quadVS",fragmentChunk:"depthAwareBlurPS",fragmentDefines:a});let o=this.device.scope;this.sourceTextureId=o.resolve("sourceTexture"),this.sourceInvResolutionId=o.resolve("sourceInvResolution"),this.sourceInvResolutionValue=new Float32Array(2),this.filterSizeId=o.resolve("filterSize")}execute(){this.filterSizeId.setValue(4),this.sourceTextureId.setValue(this.sourceTexture);let{width:e,height:t}=this.sourceTexture;this.sourceInvResolutionValue[0]=1/e,this.sourceInvResolutionValue[1]=1/t,this.sourceInvResolutionId.setValue(this.sourceInvResolutionValue),super.execute()}}var ei=`
	#include "screenDepthPS"
...
`;class el extends g{radius=5;intensity=1;power=1;sampleCount=10;minAngle=5;randomize=!1;ssaoTexture;_scale=1;_blueNoise=new er.d(19);constructor(e,t,r,a){super(e),this.sourceTexture=t,this.cameraComponent=r,T.W.get(e,"glsl").set("ssaoPS",ei),T.W.get(e,"wgsl").set("ssaoPS",en);let o=new Map;x.lo.addScreenDepthChunkDefines(r.shaderParams,o),this.shader=x.lo.createShader(e,{uniqueName:"SsaoShader",attributes:{aPosition:d.JY},vertexChunk:"quadVS",fragmentChunk:"ssaoPS",fragmentDefines:o});let i=this.createRenderTarget("SsaoFinalTexture");this.ssaoTexture=i.colorBuffer,this.init(i,{resizeSource:this.sourceTexture});let n=new s.Q(0,0,0,0);if(this.setClearColor(n),a){let t=this.createRenderTarget("SsaoTempTexture"),s=new eo(e,i.colorBuffer,r,!0);s.init(t,{resizeSource:i.colorBuffer}),s.setClearColor(n);let a=new eo(e,t.colorBuffer,r,!1);a.init(i,{resizeSource:i.colorBuffer}),a.setClearColor(n),this.afterPasses.push(s),this.afterPasses.push(a)}this.ssaoTextureId=e.scope.resolve("ssaoTexture"),this.ssaoTextureSizeInvId=e.scope.resolve("ssaoTextureSizeInv")}destroy(){if(this.renderTarget?.destroyTextureBuffers(),this.renderTarget?.destroy(),this.renderTarget=null,this.afterPasses.length>0){let e=this.afterPasses[0].renderTarget;e?.destroyTextureBuffers(),e?.destroy()}this.afterPasses.forEach(e=>e.destroy()),this.afterPasses.length=0,super.destroy()}set scale(e){this._scale=e,this.scaleX=e,this.scaleY=e}get scale(){return this._scale}createRenderTarget(e){return new h.O({depth:!1,colorBuffer:n.g.createDataTexture2D(this.device,e,1,1,52)})}execute(){let{device:e,sourceTexture:t,sampleCount:r,minAngle:s,scale:a}=this,{width:i,height:n}=this.renderTarget.colorBuffer,l=e.scope;l.resolve("uAspect").setValue(i/n),l.resolve("uInvResolution").setValue([1/i,1/n]),l.resolve("uSampleCount").setValue([r,1/r]);let u=Math.sin(s*o.D.DEG_TO_RAD);l.resolve("uMinHorizonAngleSineSquared").setValue(u*u);let c=1/(r-.5)*62.82,h=this.radius/a,f=.1*h,d=2*f*6.282*this.intensity/r,m=.5*t.height;l.resolve("uSpiralTurns").setValue(10),l.resolve("uAngleIncCosSin").setValue([Math.cos(c),Math.sin(c)]),l.resolve("uMaxLevel").setValue(0),l.resolve("uInvRadiusSquared").setValue(1/(h*h)),l.resolve("uBias").setValue(.001),l.resolve("uPeak2").setValue(f*f),l.resolve("uIntensity").setValue(d),l.resolve("uPower").setValue(this.power),l.resolve("uProjectionScaleRadius").setValue(m*h),l.resolve("uRandomize").setValue(this.randomize?this._blueNoise.value():0),super.execute()}after(){this.ssaoTextureId.setValue(this.ssaoTexture);let e=this.sourceTexture;this.ssaoTextureSizeInvId.setValue([1/e.width,1/e.height])}}class eu{formats;stencil=!1;samples=1;sceneColorMap=!1;lastGrabLayerId=i.CTD;lastGrabLayerIsTransparent=!1;lastSceneLayerId=i.t0Z;lastSceneLayerIsTransparent=!0;taaEnabled=!1;bloomEnabled=!1;ssaoType="none";ssaoBlurEnabled=!0;prepassEnabled=!1;dofEnabled=!1;dofNearBlur=!1;dofHighQuality=!0;volumetricFogEnabled=!1}let ec=new eu;class eh extends l.B{app;prePass;scenePass;composePass;bloomPass;ssaoPass;taaPass;scenePassHalf;dofPass;volumetricFogPass;_renderTargetScale=1;layersDirty=!1;cameraFrame;rt=null;constructor(e,t,r,s={}){super(e.graphicsDevice),this.app=e,this.cameraComponent=r,this.cameraFrame=t,this.options=this.sanitizeOptions(s),this.setupRenderPasses(this.options)}destroy(){this.reset()}reset(){this.sceneTexture=null,this.sceneTextureHalf=null,this.rt&&(this.rt.destroyTextureBuffers(),this.rt.destroy(),this.rt=null),this.rtHalf&&(this.rtHalf.destroyTextureBuffers(),this.rtHalf.destroy(),this.rtHalf=null),this.beforePasses.forEach(e=>e.destroy()),this.beforePasses.length=0,this.prePass=null,this.scenePass=null,this.scenePassTransparent=null,this.colorGrabPass=null,this.composePass=null,this.bloomPass=null,this.ssaoPass=null,this.taaPass=null,this.afterPass=null,this.scenePassHalf=null,this.dofPass=null,this.volumetricFogPass=null}sanitizeOptions(e){return((e=Object.assign({},ec,e)).taaEnabled||"none"!==e.ssaoType||e.dofEnabled||e.volumetricFogEnabled)&&(e.prepassEnabled=!0),e}set renderTargetScale(e){this._renderTargetScale=e,this.scenePass&&(this.scenePass.scaleX=e,this.scenePass.scaleY=e)}get renderTargetScale(){return this._renderTargetScale}needsReset(e){let t,r,s=this.options;return e.ssaoType!==s.ssaoType||e.ssaoBlurEnabled!==s.ssaoBlurEnabled||e.taaEnabled!==s.taaEnabled||e.samples!==s.samples||e.stencil!==s.stencil||e.bloomEnabled!==s.bloomEnabled||e.prepassEnabled!==s.prepassEnabled||e.sceneColorMap!==s.sceneColorMap||e.dofEnabled!==s.dofEnabled||e.dofNearBlur!==s.dofNearBlur||e.dofHighQuality!==s.dofHighQuality||e.volumetricFogEnabled!==s.volumetricFogEnabled||(t=e.formats)!==(r=s.formats)&&(!(Array.isArray(t)&&Array.isArray(r))||t.length!==r.length||!t.every((e,t)=>e===r[t]))}update(e){e=this.sanitizeOptions(e),(this.needsReset(e)||this.layersDirty)&&(this.layersDirty=!1,this.reset()),this.options=e,this.sceneTexture||this.setupRenderPasses(this.options)}createRenderTarget(e,t,r,s,a){let o=new n.g(this.device,{name:e,width:4,height:4,format:this.hdrFormat,mipmaps:!1,minFilter:1,magFilter:1,addressU:1,addressV:1});return new h.O({colorBuffer:o,depth:t,stencil:r,samples:s,flipY:a})}setupRenderPasses(e){let{device:t}=this,r=this.cameraComponent,s=r.renderTarget;this.hdrFormat=t.getRenderableHdrFormat(e.formats,!0,e.samples)||7,this._bloomEnabled=e.bloomEnabled&&7!==this.hdrFormat,this._sceneHalfEnabled=this._bloomEnabled||e.dofEnabled,r.shaderParams.ssaoEnabled="lighting"===e.ssaoType;let a=!!s?.flipY;this.rt=this.createRenderTarget("SceneColor",!0,e.stencil,e.samples,a),this.sceneTexture=this.rt.colorBuffer,this._sceneHalfEnabled&&(this.rtHalf=this.createRenderTarget("SceneColorHalf",!1,!1,1,a),this.sceneTextureHalf=this.rtHalf.colorBuffer),this.sceneOptions={resizeSource:s,scaleX:this.renderTargetScale,scaleY:this.renderTargetScale},this.createPasses(e);let o=this.collectPasses();this.beforePasses=o.filter(e=>null!=e),this.updateCameraUseFlags()}updateCameraUseFlags(){let e=new Map,t=new Map;for(let r=0;r<this.beforePasses.length;r++){let s=this.beforePasses[r];if(s instanceof c.r){let r=s.layerRenderSteps;for(let s=0;s<r.length;s++){let a=r[s],o=a.cameraComponent;o&&(e.has(o)||e.set(o,a),t.set(o,a))}}}e.forEach(e=>{e.firstCameraUse=!0}),t.forEach(e=>{e.lastCameraUse=!0})}collectPasses(){return[this.prePass,this.ssaoPass,this.scenePass,this.colorGrabPass,this.scenePassTransparent,this.volumetricFogPass,this.taaPass,this.scenePassHalf,this.bloomPass,this.dofPass,this.composePass,this.afterPass]}createPasses(e){this.setupScenePrepass(e),this.setupSsaoPass(e);let t=this.setupScenePass(e);this.setupVolumetricFogPass(e);let r=this.setupTaaPass(e);this.setupSceneHalfPass(e,r),this.setupBloomPass(e,this.sceneTextureHalf),this.setupDofPass(e,this.sceneTexture,this.sceneTextureHalf),this.setupComposePass(e),this.setupAfterPass(e,t)}setupScenePrepass(e){if(e.prepassEnabled){let{app:e,device:t,cameraComponent:r}=this,{scene:s,renderer:a}=e;this.prePass=new et(t,s,a,r,this.sceneOptions)}}setupScenePassSettings(e){e.gammaCorrection=i.hcE,e.toneMapping=i.YJk}addCameraLayers(e,t,r,s,a=!0){let o=this.cameraComponent,{layerList:i,subLayerList:n}=e.layerComposition,l=r,u=t;for(;u<i.length;){let t=i[u],r=n[u];if(o.camera.layersSet.has(t.id)&&(e.addLayer(o,t,r,l),l=!1),u++,t.id===s&&r===a)break}return u}setupScenePass(e){let{app:t,device:r}=this,{scene:s,renderer:a}=t,o=s.layers;this.scenePass=new c.r(r,o,s,a),this.setupScenePassSettings(this.scenePass),this.scenePass.init(this.rt,this.sceneOptions);let i=e.sceneColorMap?e.lastGrabLayerId:e.lastSceneLayerId,n=e.sceneColorMap?e.lastGrabLayerIsTransparent:e.lastSceneLayerIsTransparent,l={lastAddedIndex:0,clearRenderTarget:!0};return l.lastAddedIndex=this.addCameraLayers(this.scenePass,l.lastAddedIndex,l.clearRenderTarget,i,n),l.clearRenderTarget=!1,e.sceneColorMap&&(this.colorGrabPass=new u.S(r),this.colorGrabPass.source=this.rt,this.scenePassTransparent=new c.r(r,o,s,a),this.setupScenePassSettings(this.scenePassTransparent),this.scenePassTransparent.init(this.rt),l.lastAddedIndex=this.addCameraLayers(this.scenePassTransparent,l.lastAddedIndex,l.clearRenderTarget,e.lastSceneLayerId,e.lastSceneLayerIsTransparent),this.scenePassTransparent.rendersAnything||(this.scenePassTransparent.destroy(),this.scenePassTransparent=null),this.scenePassTransparent&&e.prepassEnabled&&(this.scenePassTransparent.depthStencilOps.storeDepth=!0)),l}setupSsaoPass(e){let{ssaoBlurEnabled:t,ssaoType:r}=e,{device:s,cameraComponent:a}=this;"none"!==r&&(this.ssaoPass=new el(s,this.sceneTexture,a,t))}setupSceneHalfPass(e,t){this._sceneHalfEnabled&&(this.scenePassHalf=new b(this.device,this.sceneTexture,{boxFilter:!0,removeInvalid:!0}),this.scenePassHalf.name="RenderPassSceneHalf",this.scenePassHalf.init(this.rtHalf,{resizeSource:t,scaleX:.5,scaleY:.5}),this.scenePassHalf.setClearColor(s.Q.BLACK))}setupBloomPass(e,t){this._bloomEnabled&&(this.bloomPass=new w(this.device,t,this.hdrFormat))}setupDofPass(e,t,r){e.dofEnabled&&(this.dofPass=new H(this.device,this.cameraComponent,t,r,e.dofHighQuality,e.dofNearBlur))}setupVolumetricFogPass(e){e.volumetricFogEnabled&&(this.volumetricFogPass=new K(this.device,this.cameraComponent,this.sceneTexture,this.rt),this.volumetricFogPass.temporalDither=e.taaEnabled)}setupTaaPass(e){let t=this.sceneTexture;return e.taaEnabled&&(this.taaPass=new A(this.device,this.sceneTexture,this.cameraComponent),t=this.taaPass.historyTexture),t}setupComposePass(e){this.composePass=new F(this.device),this.composePass.bloomTexture=this.bloomPass?.bloomTexture,this.composePass.hdrScene=7!==this.hdrFormat,this.composePass.taaEnabled=e.taaEnabled,this.composePass.cocTexture=this.dofPass?.cocTexture,this.composePass.blurTexture=this.dofPass?.blurTexture,this.composePass.blurTextureUpscale=!this.dofPass?.highQuality;let t=this.cameraComponent.renderTarget;this.composePass.init(t),this.composePass.ssaoTexture="combine"===e.ssaoType?this.ssaoPass.ssaoTexture:null}setupAfterPass(e,t){let{app:r,cameraComponent:s}=this,{scene:a,renderer:o}=r,i=a.layers,n=s.renderTarget;this.afterPass=new c.r(this.device,i,a,o),this.afterPass.init(n),this.addCameraLayers(this.afterPass,t.lastAddedIndex,t.clearRenderTarget)}frameUpdate(){this.layersDirty&&this.cameraFrame.update(),super.frameUpdate();let e=this.taaPass?.update()??this.rt.colorBuffer;this.composePass.sceneTexture=e,this.scenePassHalf?.setSourceTexture(e)}}class ef{_enabled=!0;rendering={renderFormats:[18,12,14],stencil:!1,renderTargetScale:1,samples:1,sceneColorMap:!1,sceneDepthMap:!1,toneMapping:0,sharpness:0};ssao={type:"none",blurEnabled:!0,randomize:!1,intensity:.5,radius:30,samples:12,power:6,minAngle:10,scale:1};bloom={intensity:0,blurLevel:16};grading={enabled:!1,brightness:1,contrast:1,saturation:1,tint:new s.Q(1,1,1,1)};colorLUT={texture:null,intensity:1,texture2:null,intensity2:1,blend:0};vignette={intensity:0,inner:.5,outer:1,curvature:.5,color:new s.Q(0,0,0)};taa={enabled:!1,jitter:1};fringing={intensity:0};colorEnhance={enabled:!1,shadows:0,highlights:0,vibrance:0,midtones:0,dehaze:0};dof={enabled:!1,nearBlur:!1,focusDistance:100,focusRange:10,blurRadius:3,blurRings:4,blurRingPoints:5,highQuality:!0};volumetricFog={enabled:!1,light:null,tint:new s.Q(1,1,1),density:.01,heightBase:0,heightFalloff:.05,anisotropy:.6,intensity:1,ambientColor:new s.Q(1,1,1),ambientIntensity:.02,maxDistance:300,steps:24,scale:.5};debug=null;options=new eu;renderPassCamera=null;constructor(e,t){this.app=e,this.cameraComponent=t,this.updateOptions(),this.enable(),this.cameraLayersChanged=t.on("set:layers",()=>{this.renderPassCamera&&(this.renderPassCamera.layersDirty=!0)})}destroy(){this.disable(),this.cameraLayersChanged.off()}enable(){this.renderPassCamera=this.createRenderPass(),this.cameraComponent.framePasses=[this.renderPassCamera]}disable(){let e=this.cameraComponent;e.framePasses?.forEach(e=>{e.destroy()}),e.framePasses=[],e.rendering=null,e.jitter=0,e.shaderParams.ssaoEnabled=!1,this.renderPassCamera=null}createRenderPass(){return new eh(this.app,this,this.cameraComponent,this.options)}set enabled(e){this._enabled!==e&&(e?this.enable():this.disable(),this._enabled=e)}get enabled(){return this._enabled}updateOptions(){let{options:e,rendering:t,bloom:r,taa:s,ssao:a}=this;e.stencil=t.stencil,e.samples=t.samples,e.sceneColorMap=t.sceneColorMap,e.prepassEnabled=t.sceneDepthMap,e.bloomEnabled=r.intensity>0,e.taaEnabled=s.enabled,e.ssaoType=a.type,e.ssaoBlurEnabled=a.blurEnabled,e.formats=t.renderFormats.slice(),e.dofEnabled=this.dof.enabled,e.dofNearBlur=this.dof.nearBlur,e.dofHighQuality=this.dof.highQuality,e.volumetricFogEnabled=this._volumetricFogSupported()}_volumetricFogSupported(){let{volumetricFog:e,cameraComponent:t}=this;return!!e.enabled&&!!e.light&&"directional"===e.light.type&&t.projection===i.$JG}update(){if(!this._enabled)return;let e=this.cameraComponent,{options:t,renderPassCamera:r,rendering:s,bloom:a,grading:i,colorEnhance:n,vignette:l,fringing:u,taa:c,ssao:h}=this;this.updateOptions(),r.update(t);let{composePass:f,bloomPass:d,ssaoPass:m,dofPass:v,volumetricFogPass:p}=r;if(r.renderTargetScale=o.D.clamp(s.renderTargetScale,.1,1),f.toneMapping=s.toneMapping,f.sharpness=s.sharpness,t.bloomEnabled&&d&&(f.bloomIntensity=a.intensity,d.blurLevel=a.blurLevel),t.dofEnabled&&(v.focusDistance=this.dof.focusDistance,v.focusRange=this.dof.focusRange,v.blurRadius=this.dof.blurRadius,v.blurRings=this.dof.blurRings,v.blurRingPoints=this.dof.blurRingPoints),t.volumetricFogEnabled){let{volumetricFog:e}=this;p.light=e.light.light,p.tint.copy(e.tint),p.density=e.density,p.heightBase=e.heightBase,p.heightFalloff=e.heightFalloff,p.anisotropy=o.D.clamp(e.anisotropy,0,.95),p.intensity=e.intensity,p.ambientColor.copy(e.ambientColor),p.ambientIntensity=e.ambientIntensity,p.maxDistance=e.maxDistance,p.steps=o.D.clamp(e.steps,4,128),p.scale=o.D.clamp(e.scale,.25,1)}"none"!==t.ssaoType&&(m.intensity=h.intensity,m.power=h.power,m.radius=h.radius,m.sampleCount=h.samples,m.minAngle=h.minAngle,m.scale=h.scale,m.randomize=h.randomize),f.gradingEnabled=i.enabled,i.enabled&&(f.gradingSaturation=i.saturation,f.gradingBrightness=i.brightness,f.gradingContrast=i.contrast,f.gradingTint=i.tint),f.colorLUT=this.colorLUT.texture,f.colorLUTIntensity=this.colorLUT.intensity,f.colorLUT2=this.colorLUT.texture2,f.colorLUT2Intensity=this.colorLUT.intensity2,f.colorLUTBlend=this.colorLUT.blend,f.vignetteEnabled=l.intensity>0,f.vignetteEnabled&&(f.vignetteInner=l.inner,f.vignetteOuter=l.outer,f.vignetteCurvature=l.curvature,f.vignetteIntensity=l.intensity,f.vignetteColor.copy(l.color)),f.fringingEnabled=u.intensity>0,f.fringingEnabled&&(f.fringingIntensity=u.intensity),f.colorEnhanceEnabled=n.enabled,n.enabled&&(f.colorEnhanceShadows=n.shadows,f.colorEnhanceHighlights=n.highlights,f.colorEnhanceVibrance=n.vibrance,f.colorEnhanceMidtones=n.midtones,f.colorEnhanceDehaze=n.dehaze),e.jitter=c.enabled?c.jitter:0,f.debug=this.debug,"ssao"===f.debug&&"none"===t.ssaoType&&(f.debug=null),"vignette"!==f.debug||f.vignetteEnabled||(f.debug=null)}}let ed="none";class em{renderFormat=18;renderFormatFallback0=12;renderFormatFallback1=14;stencil=!1;renderTargetScale=1;samples=1;sceneColorMap=!1;sceneDepthMap=!1;toneMapping=0;sharpness=0;debug="none"}class ev{type=ed;blurEnabled=!0;intensity=.5;radius=30;samples=12;power=6;minAngle=10;scale=1}class ep{enabled=!1;intensity=.01;blurLevel=16}class eg{enabled=!1;brightness=1;contrast=1;saturation=1;tint=new s.Q(1,1,1,1)}class ex{texture=null;intensity=1;texture2=null;intensity2=1;blend=0}class ey{enabled=!1;intensity=.5;inner=.5;outer=1;curvature=.5;color=new s.Q(0,0,0,1)}class eS{enabled=!1;intensity=50}class eT{enabled=!1;shadows=0;highlights=0;midtones=0;vibrance=0;dehaze=0}class eb{enabled=!1;jitter=1}class eP{enabled=!1;highQuality=!0;nearBlur=!1;focusDistance=100;focusRange=10;blurRadius=3;blurRings=4;blurRingPoints=5}class e_{enabled=!1;light=null;tint=new s.Q(1,1,1,1);density=.01;heightBase=0;heightFalloff=.05;anisotropy=.6;intensity=1;ambientColor=new s.Q(1,1,1,1);ambientIntensity=.02;maxDistance=300;steps=24;scale=.5}class eC extends a.eF{static scriptName="cameraFrame";rendering=new em;ssao=new ev;bloom=new ep;grading=new eg;colorLUT=new ex;vignette=new ey;taa=new eb;fringing=new eS;colorEnhance=new eT;dof=new eP;volumetricFog=new e_;engineCameraFrame;initialize(){this.engineCameraFrame=new ef(this.app,this.entity.camera),this.on("enable",()=>{this.engineCameraFrame.enabled=!0}),this.on("disable",()=>{this.engineCameraFrame.enabled=!1}),this.on("destroy",()=>{this.engineCameraFrame.destroy()}),this.on("state",e=>{this.engineCameraFrame.enabled=e})}postUpdate(e){let t=this.engineCameraFrame,{rendering:r,bloom:s,grading:a,colorEnhance:o,vignette:i,fringing:n,taa:l,ssao:u,dof:c,colorLUT:h,volumetricFog:f}=this,d=t.rendering;d.renderFormats.length=0,d.renderFormats.push(r.renderFormat),d.renderFormats.push(r.renderFormatFallback0),d.renderFormats.push(r.renderFormatFallback1),d.stencil=r.stencil,d.renderTargetScale=r.renderTargetScale,d.samples=r.samples,d.sceneColorMap=r.sceneColorMap,d.sceneDepthMap=r.sceneDepthMap,d.toneMapping=r.toneMapping,d.sharpness=r.sharpness;let m=t.ssao;m.type=u.type,u.type!==ed&&(m.intensity=u.intensity,m.radius=u.radius,m.samples=u.samples,m.power=u.power,m.minAngle=u.minAngle,m.scale=u.scale);let v=t.bloom;v.intensity=s.enabled?s.intensity:0,s.enabled&&(v.blurLevel=s.blurLevel);let p=t.grading;p.enabled=a.enabled,a.enabled&&(p.brightness=a.brightness,p.contrast=a.contrast,p.saturation=a.saturation,p.tint.copy(a.tint));let g=t.colorLUT;h.texture?.resource?(g.texture=h.texture.resource,g.intensity=h.intensity):g.texture=null,h.texture2?.resource?(g.texture2=h.texture2.resource,g.intensity2=h.intensity2,g.blend=h.blend):g.texture2=null;let x=t.vignette;x.intensity=i.enabled?i.intensity:0,i.enabled&&(x.inner=i.inner,x.outer=i.outer,x.curvature=i.curvature,x.color.copy(i.color));let y=t.taa;y.enabled=l.enabled,l.enabled&&(y.jitter=l.jitter),t.fringing.intensity=n.enabled?n.intensity:0;let S=t.colorEnhance;S.enabled=o.enabled,o.enabled&&(S.shadows=o.shadows,S.highlights=o.highlights,S.midtones=o.midtones,S.vibrance=o.vibrance,S.dehaze=o.dehaze);let T=t.dof;T.enabled=c.enabled,c.enabled&&(T.highQuality=c.highQuality,T.nearBlur=c.nearBlur,T.focusDistance=c.focusDistance,T.focusRange=c.focusRange,T.blurRadius=c.blurRadius,T.blurRings=c.blurRings,T.blurRingPoints=c.blurRingPoints);let b=t.volumetricFog;b.enabled=f.enabled,f.enabled&&(b.light=f.light?.light??null,b.tint.copy(f.tint),b.density=f.density,b.heightBase=f.heightBase,b.heightFalloff=f.heightFalloff,b.anisotropy=f.anisotropy,b.intensity=f.intensity,b.ambientColor.copy(f.ambientColor),b.ambientIntensity=f.ambientIntensity,b.maxDistance=f.maxDistance,b.steps=f.steps,b.scale=f.scale),t.debug=r.debug,t.update()}}},78692(e,t,r){r.d(t,{x:()=>g});var s=r(40050),a=r(85169),o=r(48355),i=r(73398),n=r(91622),l=r(27351),u=r(70917),c=r(53322),h=r(79811);let f=new s.Z,d=`
...
`;class g extends a.eF{static scriptName="grid";static RESOLUTION_LOW=0;static RESOLUTION_MEDIUM=1;static RESOLUTION_HIGH=2;_material;_meshInstance;_halfExtents=new s.Z;_colorX=new o.Q(1,.3,.3);_colorZ=new o.Q(.3,.3,1);_resolution=g.RESOLUTION_HIGH;initialize(){if(this.entity.render)return void console.error("The entity already has a render component.");this.entity.addComponent("render",{castShadows:!1}),this._material=new i.B({uniqueName:"grid-shader",vertexGLSL:d,fragmentGLSL:m,vertexWGSL:v,fragmentWGSL:p,attributes:{vertex_position:n.JY,aUv0:n.sl}}),this._material.blendType=l.i96,this._material.cull=0,this._material.update();let e=u.e.fromGeometry(this.app.graphicsDevice,new c.b);this._meshInstance=new h.F(e,this._material),this._meshInstance.pick=!1,this.entity.render.meshInstances=[this._meshInstance],this.colorX=this._colorX,this.colorZ=this._colorZ,this.resolution=this._resolution,this._set("uHalfExtents",this._calcHalfExtents(f)),this.app.on("prerender",()=>{if(!this.enabled)return;let e=this._calcHalfExtents(f);this._halfExtents.distance(e)>.001&&this._set("uHalfExtents",e)}),this.on("enable",()=>{this._meshInstance.visible=!0}),this.on("disable",()=>{this._meshInstance.visible=!1}),this.on("destroy",this.destroy,this)}_calcHalfExtents(e){let t=this.entity.getLocalScale();return e.set(t.x/2,t.z/2)}_set(e,t){this._material&&(t instanceof o.Q&&this._material.setParameter(e,[t.r,t.g,t.b]),t instanceof s.Z&&this._material.setParameter(e,[t.x,t.y]),"number"==typeof t&&this._material.setParameter(e,t),this._material.update(),this._meshInstance.material=this._material)}set colorX(e){e instanceof o.Q&&(this._colorX.copy(e),this._set("uColorX",this._colorX))}get colorX(){return this._colorX}set colorZ(e){e instanceof o.Q&&(this._colorZ.copy(e),this._set("uColorZ",this._colorZ))}get colorZ(){return this._colorZ}set resolution(e){this._resolution=e,this._set("uResolution",this._resolution)}get resolution(){return this._resolution}destroy(){this.entity.removeComponent("render")}}},8939(e,t,r){r.d(t,{X:()=>l});var s=r(85169),a=r(93953),o=r(87789),i=r(27351),n=r(80487);class l extends s.eF{static scriptName="shadowCatcher";scale=new a.e(1,1,1);geometry;drawBucket=250;_geometryCreated=!1;initialize(){let e=new o.F;e.blendType=i.$M5,e.shadowCatcher=!0,e.useSkybox=!1,e.depthWrite=!1,e.diffuse.set(0,0,0),e.specular.set(0,0,0),e.update(),!this.geometry&&this.entity.render&&(this.geometry=this.entity),this.geometry||(this._geometryCreated=!0,this.geometry=new n.w("ShadowCatcherGeometry"),this.geometry.addComponent("render",{type:"plane",castShadows:!1,material:e})),this.geometry!==this.entity&&this.entity.addChild(this.geometry),this.geometry?.render?.meshInstances.forEach(t=>{this._geometryCreated||(t.material=e)}),this.on("destroy",()=>{this._geometryCreated&&this.geometry?.destroy(),e.destroy()})}update(){this.geometry?.setLocalScale(this.scale),this.geometry?.render?.meshInstances.forEach(e=>{e.drawBucket=this.drawBucket})}}}}]);