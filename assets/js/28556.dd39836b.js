...
`;class V extends x{focusDistance;focusRange;constructor(e,t,r){super(e),this.cameraComponent=t,b.W.get(e,"glsl").set("cocPS",M),b.W.get(e,"wgsl").set("cocPS",B);let s=new Map;r&&s.set("NEAR_BLUR",""),g.lo.addScreenDepthChunkDefines(e,t.shaderParams,s),this.shader=g.lo.createShader(e,{uniqueName:`CocShader-${r}`,attributes:{aPosition:d.JY},vertexChunk:"quadVS",fragmentChunk:"cocPS",fragmentDefines:s}),this.paramsId=e.scope.resolve("params"),this.paramsValue=new Float32Array(3),this.cameraParams=new Float32Array(4),this.cameraParamsId=e.scope.resolve("camera_params")}execute(){let{paramsValue:e,focusRange:t}=this;e[0]=this.focusDistance+.001,e[1]=t,e[2]=1/t,this.paramsId.setValue(e);let r=this.cameraComponent.camera;this.cameraParamsId.setValue(r.fillShaderParams(this.cameraParams)),super.execute()}}class z{static concentric(e,t){let r=[];r.push(0,0);let s=2*Math.PI/e/t;for(let t=1;t<=e;t++){let o=t/e,a=Math.max(1,Math.floor(2*Math.PI*o/s)),i=2*Math.PI/a;for(let e=0;e<a;e++){let t=e*i,s=o*Math.cos(t),a=o*Math.sin(t);r.push(s,a)}}return r}}var N=`
