...
`;class S extends v.s{execute(){this.sourceTextureId.setValue(this.sourceTexture),this.sourceInvResolutionValue[0]=1/this.sourceTexture.width,this.sourceInvResolutionValue[1]=1/this.sourceTexture.height,this.sourceInvResolutionId.setValue(this.sourceInvResolutionValue),super.execute()}constructor(e,t){super(e),this.sourceTexture=t,g.W.get(e,"glsl").set("upsamplePS",b),g.W.get(e,"wgsl").set("upsamplePS",T),this.shader=p.lo.createShader(e,{uniqueName:"UpSampleShader",attributes:{aPosition:d.JY},vertexChunk:"quadVS",fragmentChunk:"upsamplePS"}),this.sourceTextureId=e.scope.resolve("sourceTexture"),this.sourceInvResolutionId=e.scope.resolve("sourceInvResolution"),this.sourceInvResolutionValue=new Float32Array(2)}}class P extends l.A{destroy(){this.destroyRenderPasses(),this.destroyRenderTargets()}destroyRenderTargets(e=0){for(let t=e;t<this.renderTargets.length;t++){let e=this.renderTargets[t];e.destroyTextureBuffers(),e.destroy()}this.renderTargets.length=0}destroyRenderPasses(){for(let e=0;e<this.beforePasses.length;e++)this.beforePasses[e].destroy();this.beforePasses.length=0}createRenderTarget(e){return new h.O({depth:!1,colorBuffer:new n.g(this.device,{name:`BloomTexture${e}`,width:1,height:1,format:this.textureFormat,mipmaps:!1,minFilter:1,magFilter:1,addressU:1,addressV:1})})}createRenderTargets(e){for(let t=0;t<e;t++){let e=0===t?this.bloomRenderTarget:this.createRenderTarget(t);this.renderTargets.push(e)}}calcMipLevels(e,t,r){return Math.floor(Math.log2(Math.min(e,t))-Math.log2(r))}createRenderPasses(e){let t=this.device,r=this._sourceTexture;for(let o=0;o<e;o++){let e=new y(t,r),i=this.renderTargets[o];e.init(i,{resizeSource:r,scaleX:.5,scaleY:.5}),e.setClearColor(s.Q.BLACK),this.beforePasses.push(e),r=i.colorBuffer}r=this.renderTargets[e-1].colorBuffer;for(let s=e-2;s>=0;s--){let e=new S(t,r),o=this.renderTargets[s];e.init(o),e.blendState=f.t.ADDBLEND,this.beforePasses.push(e),r=o.colorBuffer}}onDisable(){this.renderTargets[0]?.resize(1,1),this.destroyRenderPasses(),this.destroyRenderTargets(1)}frameUpdate(){super.frameUpdate();let e=this.calcMipLevels(this._sourceTexture.width,this._sourceTexture.height,1),t=i.D.clamp(e,1,this.blurLevel);this.renderTargets.length!==t&&(this.destroyRenderPasses(),this.destroyRenderTargets(1),this.createRenderTargets(t),this.createRenderPasses(t))}constructor(e,t,r){super(e),this.blurLevel=16,this.renderTargets=[],this._sourceTexture=t,this.textureFormat=r,this.bloomRenderTarget=this.createRenderTarget(0),this.bloomTexture=this.bloomRenderTarget.colorBuffer}}var C=r(88525);let _={composePS:`
...
`,composeColorLutPS:`
	...
	#endif
`,composeDeclarationsPS:"",composeMainStartPS:"",composeMainEndPS:""},R={composePS:`
	#include "tonemappingPS"
	#include "gammaPS"
	varying uv0: vec2f;
...
`;class O extends v.s{destroy(){this.renderTarget&&(this.renderTarget.destroyTextureBuffers(),this.renderTarget.destroy(),this.renderTarget=null)}setup(){for(let e=0;e<2;++e)this.historyTextures[e]=new n.g(this.device,{name:`TAA-History-${e}`,width:4,height:4,format:this.sourceTexture.format,mipmaps:!1,minFilter:1,magFilter:1,addressU:1,addressV:1}),this.historyRenderTargets[e]=new h.O({colorBuffer:this.historyTextures[e],depth:!1});this.historyTexture=this.historyTextures[0],this.init(this.historyRenderTargets[0],{resizeSource:this.sourceTexture})}before(){this.sourceTextureId.setValue(this.sourceTexture),this.historyTextureId.setValue(this.historyTextures[1-this.historyIndex]),this.textureSize[0]=this.sourceTexture.width,this.textureSize[1]=this.sourceTexture.height,this.textureSizeId.setValue(this.textureSize);let e=this.cameraComponent.camera;this.viewProjPrevId.setValue(e._viewProjPrevious.data),this.viewProjInvId.setValue(e._viewProjInverse.data),this.jittersId.setValue(e._jitters),this.cameraParamsId.setValue(e.fillShaderParams(this.cameraParams))}update(){return this.historyIndex=1-this.historyIndex,this.historyTexture=this.historyTextures[this.historyIndex],this.renderTarget=this.historyRenderTargets[this.historyIndex],this.historyTexture}constructor(e,t,r){super(e),this.historyIndex=0,this.historyTexture=null,this.historyTextures=[],this.historyRenderTargets=[],this.sourceTexture=t,this.cameraComponent=r,g.W.get(e,"glsl").set("sampleCatmullRomPS",w),g.W.get(e,"wgsl").set("sampleCatmullRomPS",D),g.W.get(e,"glsl").set("taaResolvePS",I),g.W.get(e,"wgsl").set("taaResolvePS",L);let s=new Map;s.set("QUALITY_HIGH",!0),p.lo.addScreenDepthChunkDefines(e,r.shaderParams,s),this.shader=p.lo.createShader(e,{uniqueName:"TaaResolveShader",attributes:{aPosition:d.JY},vertexChunk:"quadVS",fragmentChunk:"taaResolvePS",fragmentDefines:s});let{scope:o}=e;this.sourceTextureId=o.resolve("sourceTexture"),this.textureSizeId=o.resolve("textureSize"),this.textureSize=new Float32Array(2),this.historyTextureId=o.resolve("historyTexture"),this.viewProjPrevId=o.resolve("matrix_viewProjectionPrevious"),this.viewProjInvId=o.resolve("matrix_viewProjectionInverse"),this.jittersId=o.resolve("jitters"),this.cameraParams=new Float32Array(4),this.cameraParamsId=o.resolve("camera_params"),this.setup()}}var A=`
	#include "screenDepthPS"
	varying vec2 uv0;
	uniform vec3 params;
	void main()
...
`;class U extends v.s{execute(){let{paramsValue:e,focusRange:t}=this;e[0]=this.focusDistance+.001,e[1]=t,e[2]=1/t,this.paramsId.setValue(e);let r=this.cameraComponent.camera;this.cameraParamsId.setValue(r.fillShaderParams(this.cameraParams)),super.execute()}constructor(e,t,r){super(e),this.cameraComponent=t,g.W.get(e,"glsl").set("cocPS",A),g.W.get(e,"wgsl").set("cocPS",F);let s=new Map;r&&s.set("NEAR_BLUR",""),p.lo.addScreenDepthChunkDefines(e,t.shaderParams,s),this.shader=p.lo.createShader(e,{uniqueName:`CocShader-${r}`,attributes:{aPosition:d.JY},vertexChunk:"quadVS",fragmentChunk:"cocPS",fragmentDefines:s}),this.paramsId=e.scope.resolve("params"),this.paramsValue=new Float32Array(3),this.cameraParams=new Float32Array(4),this.cameraParamsId=e.scope.resolve("camera_params")}}class M{static concentric(e,t){let r=[];r.push(0,0);let s=2*Math.PI/e/t;for(let t=1;t<=e;t++){let o=t/e,i=Math.max(1,Math.floor(2*Math.PI*o/s)),a=2*Math.PI/i;for(let e=0;e<i;e++){let t=e*a,s=o*Math.cos(t),i=o*Math.sin(t);r.push(s,i)}}return r}}var B=`
...
`;class z extends v.s{set blurRings(e){this._blurRings!==e&&(this._blurRings=e,this.shader=null)}get blurRings(){return this._blurRings}set blurRingPoints(e){this._blurRingPoints!==e&&(this._blurRingPoints=e,this.shader=null)}get blurRingPoints(){return this._blurRingPoints}createShader(){this.kernel=new Float32Array(M.concentric(this.blurRings,this.blurRingPoints));let e=this.kernel.length>>1,t=null!==this.nearTexture,r=new Map;r.set("{KERNEL_COUNT}",e),r.set("{INV_KERNEL_COUNT}",1/e),t&&r.set("NEAR_BLUR",""),this.shader=p.lo.createShader(this.device,{uniqueName:`DofBlurShader-${e}-${t?"nearBlur":"noNearBlur"}`,attributes:{aPosition:d.JY},vertexChunk:"quadVS",fragmentChunk:"dofBlurPS",fragmentDefines:r})}execute(){this.shader||this.createShader(),this.nearTextureId.setValue(this.nearTexture),this.farTextureId.setValue(this.farTexture),this.cocTextureId.setValue(this.cocTexture),this.kernelId.setValue(this.kernel),this.kernelCountId.setValue(this.kernel.length>>1),this.blurRadiusNearId.setValue(this.blurRadiusNear),this.blurRadiusFarId.setValue(this.blurRadiusFar),super.execute()}constructor(e,t,r,s){super(e),this.blurRadiusNear=1,this.blurRadiusFar=1,this._blurRings=3,this._blurRingPoints=3,this.nearTexture=t,this.farTexture=r,this.cocTexture=s,g.W.get(e,"glsl").set("dofBlurPS",B),g.W.get(e,"wgsl").set("dofBlurPS",V);let{scope:o}=e;this.kernelId=o.resolve("kernel[0]"),this.kernelCountId=o.resolve("kernelCount"),this.blurRadiusNearId=o.resolve("blurRadiusNear"),this.blurRadiusFarId=o.resolve("blurRadiusFar"),this.nearTextureId=o.resolve("nearTexture"),this.farTextureId=o.resolve("farTexture"),this.cocTextureId=o.resolve("cocTexture")}}class N extends l.A{destroy(){this.destroyRenderPasses(),this.cocPass=null,this.farPass=null,this.blurPass=null,this.destroyRT(this.cocRT),this.destroyRT(this.farRt),this.destroyRT(this.blurRt),this.cocRT=null,this.farRt=null,this.blurRt=null}destroyRenderPasses(){for(let e=0;e<this.beforePasses.length;e++)this.beforePasses[e].destroy();this.beforePasses.length=0}destroyRT(e){e&&(e.destroyTextureBuffers(),e.destroy())}setupCocPass(e,t,r,o){this.cocRT=this.createRenderTarget("CoCTexture",o?53:52),this.cocTexture=this.cocRT.colorBuffer;let i=new U(e,t,o);return i.init(this.cocRT,{resizeSource:r}),i.setClearColor(s.Q.BLACK),i}setupFarPass(e,t,r){this.farRt=this.createRenderTarget("FarDofTexture",t.format);let o=new y(e,t,{boxFilter:!0,premultiplyTexture:this.cocTexture,premultiplySrcChannel:"r"});return o.init(this.farRt,{resizeSource:t,scaleX:r,scaleY:r}),o.setClearColor(s.Q.BLACK),o}setupBlurPass(e,t,r,o){let i=this.farRt?.colorBuffer;this.blurRt=this.createRenderTarget("DofBlurTexture",t.format),this.blurTexture=this.blurRt.colorBuffer;let a=new z(e,r?t:null,i,this.cocTexture);return a.init(this.blurRt,{resizeSource:t,scaleX:o,scaleY:o}),a.setClearColor(s.Q.BLACK),a}createTexture(e,t){return new n.g(this.device,{name:e,width:1,height:1,format:t,mipmaps:!1,minFilter:1,magFilter:1,addressU:1,addressV:1})}createRenderTarget(e,t){return new h.O({colorBuffer:this.createTexture(e,t),depth:!1,stencil:!1})}frameUpdate(){super.frameUpdate(),this.cocPass.focusDistance=this.focusDistance,this.cocPass.focusRange=this.focusRange,this.blurPass.blurRadiusNear=this.blurRadius,this.blurPass.blurRadiusFar=this.blurRadius*(this.highQuality?1:.5),this.blurPass.blurRings=this.blurRings,this.blurPass.blurRingPoints=this.blurRingPoints}constructor(e,t,r,s,o,i){super(e),this.focusDistance=100,this.focusRange=50,this.blurRadius=1,this.blurRings=3,this.blurRingPoints=3,this.highQuality=!0,this.cocTexture=null,this.blurTexture=null,this.cocPass=null,this.farPass=null,this.blurPass=null,this.highQuality=o,this.cocPass=this.setupCocPass(e,t,r,i),this.beforePasses.push(this.cocPass);let a=o?r:s;this.farPass=this.setupFarPass(e,a,.5),this.beforePasses.push(this.farPass),this.blurPass=this.setupBlurPass(e,s,i,o?2:.5),this.beforePasses.push(this.blurPass)}}var k=r(33984);let W=[];class G extends l.A{destroy(){super.destroy(),this.renderTarget?.destroy(),this.renderTarget=null,this.linearDepthTexture?.destroy(),this.linearDepthTexture=null,this.viewBindGroups.forEach(e=>{e.defaultUniformBuffer.destroy(),e.destroy()}),this.viewBindGroups.length=0}setupRenderTarget(e){let{device:t}=this;this.linearDepthFormat=t.textureFloatRenderable?15:7,this.linearDepthTexture=n.g.createDataTexture2D(t,"SceneLinearDepthTexture",1,1,this.linearDepthFormat);let r=new h.O({name:"PrepassRT",colorBuffer:this.linearDepthTexture,depth:!0,samples:1});this.camera.shaderParams.sceneDepthMapLinear=!0,this.init(r,e)}after(){this.device.scope.resolve("uSceneDepthMap").setValue(this.linearDepthTexture)}execute(){let{renderer:e,scene:t,renderTarget:r}=this,s=this.camera.camera,o=t.layers.layerList,i=t.layers.subLayerEnabled,n=t.layers.subLayerList;for(let t=0;t<o.length;t++){let l=o[t];if(l.id===a.$9T)break;if(l.enabled&&i[t]&&l.camerasSet.has(s)){let o=l.getCulledInstances(s),i=n[t]?o.transparent:o.opaque;for(let e=0;e<i.length;e++){let t=i[e];t.material?.depthWrite&&W.push(t)}e.renderForwardLayer(s,r,null,void 0,a.pP7,this.viewBindGroups,{meshInstances:W}),W.length=0}}}frameUpdate(){let e;super.frameUpdate();let{camera:t}=this;if(this.setClearDepth(t.clearDepthBuffer?1:void 0),t.clearDepthBuffer){let r=t.farClip-5e-324;e=this.linearDepthClearValue,15===this.linearDepthFormat?e.r=r:k.A.float2RGBA8(r,e)}this.setClearColor(e)}constructor(e,t,r,o,i){super(e),this.viewBindGroups=[],this.linearDepthClearValue=new s.Q(0,0,0,0),this.scene=t,this.renderer=r,this.camera=o,this.setupRenderTarget(i)}}var H=r(60017),j=`
	#include "screenDepthPS"
	varying vec2 uv0;
	uniform sampler2D sourceTexture;
	uniform vec2 sourceInvResolution;
