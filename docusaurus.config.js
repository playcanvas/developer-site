  ...
  plugins: [
    [ '@docusaurus/plugin-client-redirects', {
      redirects: [
        ...
        { from: ['/user-manual/ai/', '/en/user-manual/ai/'], to: '/user-manual/' },
        { from: ['/user-manual/ai/developing-with-engine/', '/en/user-manual/ai/developing-with-engine/'], to: '/user-manual/engine/ai-development/' },
        { from: ['/user-manual/ai/editor-mcp-server/', '/en/user-manual/ai/editor-mcp-server/'], to: '/user-manual/editor/mcp-server/' },
        { from: ['/user-manual/ai/vscode-extension/', '/en/user-manual/ai/vscode-extension/'], to: '/user-manual/editor/scripting/vscode-extension/' },
