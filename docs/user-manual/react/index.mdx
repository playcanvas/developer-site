...
description: "Introduction to @playcanvas/react: declarative 3D in React, ECS alignment, documentation map, and links to guides and GitHub."
---
...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(250px, 1fr))', gap: '20px', marginBottom: '40px' }}>
  <a
    href="/user-manual/react/examples/physics"
  ...
  >
    ...
    <div style={{ marginTop: '12px' }}>
      ...
      <div style={{ opacity: 0.8 }}>Disturb rigid bodies in zero gravity.</div>
    </div>
  </a>
  <a
  ...
  >
    ...
    <div style={{ marginTop: '12px' }}>
      ...
      <div style={{ opacity: 0.8 }}>Open a simple PlayCanvas React template in StackBlitz.</div>
    </div>
  </a>
</div>
