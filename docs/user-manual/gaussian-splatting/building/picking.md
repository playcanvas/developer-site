...
GSplat components can operate in unified or non-unified rendering mode (see [Global Sorting](./global-sorting.md) for details). The picking behavior differs between these modes:
