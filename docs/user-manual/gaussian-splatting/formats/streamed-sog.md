...
You can create streamed SOG datasets with **[SplatTransform](https://github.com/playcanvas/splat-transform)** — see the [Streamed SOG guide](https://github.com/playcanvas/splat-transform/blob/main/guides/STREAMED_SOG.md) for a step-by-step walkthrough. Individual chunks are standard [SOG](./sog.md) datasets.
