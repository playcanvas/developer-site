...
![Sign Up](pathname:///img/user-manual/account-management/user-accounts/sign-up.png)
...
![Sign Up Form](pathname:///img/user-manual/account-management/user-accounts/sign-up-form.png)

If you select the Username and Password option, you will be asked to confirm your email address:

![Confirm Email](pathname:///img/user-manual/account-management/user-accounts/sign-up-confirm-email.png)

Head to your email inbox and click the verification link. You will be taken to this page:

![Email Verified](pathname:///img/user-manual/account-management/user-accounts/sign-up-email-verified.png)

On hitting continue, you'll be prompted to add some details about yourself:

![Details Form](pathname:///img/user-manual/account-management/user-accounts/sign-up-details-form.png)
...
![Roll Ball](pathname:///img/user-manual/account-management/user-accounts/sign-up-roll-ball.png)
