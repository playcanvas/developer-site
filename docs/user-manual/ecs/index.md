...
:::ai
Use **[AI Development](/user-manual/engine/ai-development/)** or the **[Editor MCP Server](/user-manual/editor/mcp-server/)** to create entities, configure components, and inspect the resulting hierarchy.
:::
