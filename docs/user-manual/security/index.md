---
title: Security
description: Report security vulnerabilities in PlayCanvas through Snap Inc.'s HackerOne bug bounty program. Learn about in-scope domains and responsible disclosure.
sidebar_label: Security
---

PlayCanvas is part of [Snap Inc.](https://snap.com/) and security vulnerabilities affecting PlayCanvas services are handled through Snap's [HackerOne](https://hackerone.com/snapchat) bug bounty program.
...
[**Report a vulnerability on HackerOne →**](https://hackerone.com/snapchat)
...
| Domain | Purpose |
| ------ | ------- |
| [`playcanvas.com`](https://playcanvas.com) | Main website, dashboard, and Editor |
| [`developer.playcanvas.com`](https://developer.playcanvas.com) | Developer documentation (this site) |
| [`forum.playcanvas.com`](https://forum.playcanvas.com) | Community forum |
...
| [`store.playcanvas.com`](https://store.playcanvas.com) | Asset store |
| `playcanv.as` | Published apps hosting |

For the most up-to-date scope, eligibility rules, and full program policy, refer to the official [HackerOne policy and scopes page](https://hackerone.com/snapchat/policy_scopes).
