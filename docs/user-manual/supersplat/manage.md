...
![The Manage page table with several splats](pathname:///img/user-manual/supersplat/manage.png)
...
![The Edit Splat dialog](pathname:///img/user-manual/supersplat/edit.png)
