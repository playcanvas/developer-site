...
|-----------|-------------|
| `.ply` | Standard PLY (uncompressed) |
| `.sog` | Bundled super-compressed format |
| `.compressed.ply` | Compressed PLY (quantized) |
| `.ksplat` | mkkellogg compressed splat format |
| `.splat` | antimatter15 compressed splat format |
| `.spz` | Niantic compressed splat format |
...
| Error | Cause |
|-------|-------|
| **Unrecognized format** | The file extension isn't in the supported list above. |
