...
description: "Grade the colors of a splat or selection with the Scene Manager's Colors section, and control how Gaussians, centers, rings, and selections are drawn with the Appearance popup."
---
...
1. Set the viewport tone mapping in [Preferences](interface.md#preferences) and the background color in [Appearance](#appearance), so you are judging the scene in its intended viewing conditions.
...
The **Colors** row sets the viewport's **Background Color** and the **Selected**, **Unselected**, and **Locked** colors used by the overlays, the tints, and the [Splat Data](data-panel.md) histogram.
