...
![The bumblebee splat's scene page — a central embedded viewer beside a sidebar of metadata and actions](pathname:///img/user-manual/supersplat/scene-page.webp)
