...
![9 Sliced Button](pathname:///img/user-manual/2D/9-slicing/9-sliced-labelled.jpg)
...
![Button Resize Animation](pathname:///img/user-manual/2D/9-slicing/button-resize.gif)

## Setting up 9-slicing

![Setup 9-slicing](pathname:///img/user-manual/2D/9-slicing/9-slice-setup.jpg)
...
![Simple Render Mode](pathname:///img/user-manual/2D/9-slicing/simple-resize.gif)

*Simple* Render Mode has no 9-slicing. Use this mode for regular sprites.

### Sliced Sprites

![Sliced Render Mode](pathname:///img/user-manual/2D/9-slicing/sliced-resize.gif)
...
![Tiled Render Mode](pathname:///img/user-manual/2D/9-slicing/tiled-resize.gif)
