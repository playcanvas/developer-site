...
The [Cube Jump project](https://playcanvas.com/project/354998/overview/cube-jump-playable-ad-for-fb) is ready to be exported for the Facebook Playable Ad format and the expected [HTML output can be found here](/downloads/fb-playable-ad-cube-jump-html.zip).
