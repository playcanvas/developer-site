...
description: Sets up a Cordova project, copies a PlayCanvas build into www, and covers iOS audio limits and PlayCanvas tooling links.
---
...
![Master Archer in Simulator](pathname:///img/user-manual/editor/publishing/cordova/simulator-master-archer.png)
...
4. Select your iOS device in Xcode's Scheme drop-down list.
    ...
    ![Xcode Scheme drop-down](pathname:///img/user-manual/editor/publishing/cordova/xcode-scheme.png)

5. Press the Run button to build, deploy and run the application on your device.

    ![Xcode Run button](pathname:///img/user-manual/editor/publishing/cordova/xcode-run.png)
