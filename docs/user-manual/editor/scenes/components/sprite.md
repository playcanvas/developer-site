...
- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** Add or remove Sprite Components, configure their properties on entities, and launch or capture the scene to verify them.
