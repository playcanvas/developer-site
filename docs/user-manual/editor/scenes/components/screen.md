...
| Resolution           | When Screen Space is false. The resolution of the screen coordinates. Screen coordinates go up as you move right and up. For Screen Space components the resolution is always determined from the resolution of the canvas. |
