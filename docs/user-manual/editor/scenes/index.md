...
:::ai
The **[Editor MCP Server](/user-manual/editor/mcp-server/)** can modify scenes, entities, components, and settings, then verify the result in the viewport or running application.
:::
