...
![Viewport](pathname:///img/user-manual/editor/viewport/viewport.jpg)
...
![Camera Dropdown](pathname:///img/user-manual/editor/viewport/camera-dropdown.jpg)
...
![Gizmos](pathname:///img/user-manual/editor/viewport/gizmos.jpg)
...
| Component | Icon |
| --------- | ---- |
| [Camera](/user-manual/editor/scenes/components/camera) | ![Camera icon](pathname:///img/user-manual/editor/viewport/entity-icons/camera.png) |
| [Light](/user-manual/editor/scenes/components/light) — directional | ![Directional light icon](pathname:///img/user-manual/editor/viewport/entity-icons/light-directional.png) |
| [Light](/user-manual/editor/scenes/components/light) — omni | ![Omni light icon](pathname:///img/user-manual/editor/viewport/entity-icons/light-point.png) |
| [Light](/user-manual/editor/scenes/components/light) — spot | ![Spot light icon](pathname:///img/user-manual/editor/viewport/entity-icons/light-spot.png) |
| [Script](/user-manual/editor/scenes/components/script) | ![Script icon](pathname:///img/user-manual/editor/viewport/entity-icons/script.png) |
| [Animation](/user-manual/editor/scenes/components/animation) | ![Animation icon](pathname:///img/user-manual/editor/viewport/entity-icons/animation.png) |
...
![Viewport Render Mode Menu](pathname:///img/user-manual/editor/viewport/render-mode-menu.png)

It allows you to toggle wireframe rendering:

![Viewport Wireframe](pathname:///img/user-manual/editor/viewport/wireframe.png)
...
![Viewport Render Modes](pathname:///img/user-manual/editor/viewport/render-modes.png)
