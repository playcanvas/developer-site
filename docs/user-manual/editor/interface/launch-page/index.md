...
:::ai
The **[Editor MCP Server](/user-manual/editor/mcp-server/)** can launch the application, provide input, inspect console output and live entity state, and capture the result.
:::
