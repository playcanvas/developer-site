...
![assets](pathname:///img/user-manual/introduction/workflow-assets.jpg)
...
![scene](pathname:///img/user-manual/introduction/workflow-create-scene.jpg)
...
![script](pathname:///img/user-manual/introduction/workflow-script.jpg)
...
![publish](pathname:///img/user-manual/introduction/workflow-publish.jpg)
