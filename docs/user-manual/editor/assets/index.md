...
:::ai
Before replacing a widely used asset, ask an AI assistant through the **[Editor MCP Server](/user-manual/editor/mcp-server/)** to trace dependencies and summarize the impact. Approve the references it updates, then inspect affected scenes.
:::
