---
title: Branches
description: Documents main branch current branch creation favorites search closing deletion and collaborator expectations for branch lines.
---
...
![Create branch](pathname:///img/user-manual/editor/version-control/branches/new-branch.png)
...
![New branch dialog](pathname:///img/user-manual/editor/version-control/branches/new-branch-dialog.png)
...
![Branch filter](pathname:///img/user-manual/editor/version-control/branches/filter-branches.gif)
...
![Favorite a branch via menu](pathname:///img/user-manual/editor/version-control/branches/favorite-branch-via-dropdown.gif)

### Selected branch button {#selected-branch-button}

![Favorite a branch via button](pathname:///img/user-manual/editor/version-control/branches/favorite-branch-via-button.gif)

## Searching for a branch {#searching-for-a-branch}

![Searching for a branch](pathname:///img/user-manual/editor/version-control/branches/search-for-a-branch.gif)
...
![Switch branch](pathname:///img/user-manual/editor/version-control/branches/switch-branch.png)
...
![Close branch](pathname:///img/user-manual/editor/version-control/branches/close-branch.png)
...
![Close branch dialog](pathname:///img/user-manual/editor/version-control/branches/close-branch-dialog.png)
...
![Delete a branch](pathname:///img/user-manual/editor/version-control/branches/delete-branch.png)
...
![Delete a branch warning](pathname:///img/user-manual/editor/version-control/branches/delete-branch-dialog.png)
