...
![Feature branches](pathname:///img/user-manual/editor/version-control/branch-workflows/feature-branches.png)
...
![Release branches](pathname:///img/user-manual/editor/version-control/branch-workflows/release-branches.png)
...
![Continuous Delivery](pathname:///img/user-manual/editor/version-control/branch-workflows/continuous-delivery.png)
