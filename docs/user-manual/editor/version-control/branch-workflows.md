...
![Feature branches](/img/user-manual/editor/version-control/branch-workflows/feature-branches.png)
...
![Release branches](/img/user-manual/editor/version-control/branch-workflows/release-branches.png)
...
![Continuous Delivery](/img/user-manual/editor/version-control/branch-workflows/continuous-delivery.png)
