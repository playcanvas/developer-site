...
![Initial Editor](pathname:///img/user-manual/animation/state-graph-editor.png)
...
![State](pathname:///img/user-manual/animation/state.png)
...
![Start State](pathname:///img/user-manual/animation/start-state.png)
...
![Layers](pathname:///img/user-manual/animation/layers.png)
...
![End State](pathname:///img/user-manual/animation/end-state.png)
...
![Any State](pathname:///img/user-manual/animation/any-state.png)
...
![Parameters](pathname:///img/user-manual/animation/parameters.png)
...
![Condition](pathname:///img/user-manual/animation/condition.png)
...
![Select Layer](pathname:///img/user-manual/animation/select-layer.png)
...
![Layer Blend](pathname:///img/user-manual/animation/anim-layer-blend.png)
