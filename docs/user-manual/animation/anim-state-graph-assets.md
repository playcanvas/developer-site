...
![State](/img/user-manual/animation/state.png)
...
![Layers](/img/user-manual/animation/layers.png)
...
![Parameters](/img/user-manual/animation/parameters.png)
...
![Condition](/img/user-manual/animation/condition.png)
