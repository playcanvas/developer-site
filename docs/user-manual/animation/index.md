...
:::ai
Use **[AI Development](/user-manual/engine/ai-development/)** or the **[Editor MCP Server](/user-manual/editor/mcp-server/)** to configure animation assets and state graphs, then verify playback and transitions.
:::
