...
![Screen space](pathname:///img/user-manual/user-interface/screens/screen-space-viewport.png)
...
![World Space](pathname:///img/user-manual/user-interface/screens/world-space-viewport.png)
...
![iPad No Scaling](pathname:///img/user-manual/user-interface/screens/ipad-no-scaling.png)
...
![iPhone No Scaling](pathname:///img/user-manual/user-interface/screens/iphone-no-scaling.png)
...
![iPad Scaling](pathname:///img/user-manual/user-interface/screens/ipad-scaling.png)

and on the iPhone

![iPhone Scaling](pathname:///img/user-manual/user-interface/screens/iphone-scaling.png)
...
![Scale Blend 0](pathname:///img/user-manual/user-interface/screens/scale-blend-0.png)
With a value of 0 the increase in horizontal resolution makes the button too large

![Scale Blend 1](pathname:///img/user-manual/user-interface/screens/scale-blend-1.png)
With a value of 1 the decrease in vertical resolution makes the button too small

![Scale Blend 0.5](pathname:///img/user-manual/user-interface/screens/scale-blend-0.5.png)
