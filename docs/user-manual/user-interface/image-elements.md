...
![Tinting](pathname:///img/user-manual/user-interface/image-element/image-tinted.png)

## Transparency

As with the color property, the opacity property can be used to set the transparency level of an Element.

![Transparent](pathname:///img/user-manual/user-interface/image-element/image-transparent.png)
