...
:::ai
Use **[AI Development](/user-manual/engine/ai-development/)** or the **[Editor MCP Server](/user-manual/editor/mcp-server/)** to configure physics behavior, launch the scene, and inspect collisions or runtime state.
:::
