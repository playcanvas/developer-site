...
![Workflows](pathname:///img/user-manual/graphics/physical-rendering/specular-metalness-workflows.png)
...
![Metals](pathname:///img/user-manual/graphics/physical-rendering/metals.jpg)
