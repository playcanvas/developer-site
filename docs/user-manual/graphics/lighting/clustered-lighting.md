...
2. Place a world space 3D grid over the axis aligned bounds of all visible lights.
    ...
    ![3D Grid](pathname:///img/user-manual/graphics/lighting/lights/3d-grid.png)
...
![Clustered Lighting Editor UI](pathname:///img/user-manual/graphics/lighting/lights/clustered-lighting-ui.png)
...
![3D Grid Configuration](pathname:///img/user-manual/graphics/lighting/lights/3d-grid-config.png)
...
- **Automatic** – When the array size is specified as 0, the engine automatically splits the atlas as needed, to assign each visible light an equally sized sub-texture. For example, if you have three lights visible in a frame, the atlas will split into 2x2 sub-textures, and three of those four sub-textures will be assigned to the lights.
    ...
    ![Atlas Split 0](pathname:///img/user-manual/graphics/lighting/lights/atlas-split-0.png)
...
![Manual Split](pathname:///img/user-manual/graphics/lighting/lights/manual-split.png)

The following image shows how the manual atlas split should be specified.

![Atlas Split 2](pathname:///img/user-manual/graphics/lighting/lights/atlas-split-2.png)
