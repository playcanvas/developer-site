...
PlayCanvas ships with a [physics system](/docs/user-manual/physics/). This enables realistic simulations of objects in 3D space, including gravity, collisions, forces, and constraints. The physics system is powered by the [Ammo.js](https://github.com/kripken/ammo.js) physics engine.
...
You can customize physics behavior by changing the various properties of the `RigidBody` and `Collision` components. Check out the [Physics documentation](/docs/user-manual/physics/) for more information.
