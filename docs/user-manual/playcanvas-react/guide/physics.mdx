...
Because the physics engine is lazily loaded and instantiated you'll often want to to check the physics state to ensure it's loaded before you can use it. This allows you to handle the loading state in a reactive way.
...
You can read more about the `usePhysics` hook in the [API reference](/user-manual/playcanvas-react/api/use-physics).

For more detailed information about PlayCanvas physics, see the [PlayCanvas Physics Documentation](/user-manual/physics/).
