...
The Engine itself uses an **Entity Component System** - it's a common architecture used by many game engines that separates out behaviour from data. ECS maps incredibly well to the declarative nature of React. It allows you to structure your scene in a way that is easy to understand and maintain.
...
Now you have the basics, it's time to learn about [Interactivity](/docs/user-manual/playcanvas-react/guide/interactivity), how to [manage assets](/docs/user-manual/playcanvas-react/guide/loading-assets) and how to use [Physics](/docs/user-manual/playcanvas-react/guide/physics) in your project. With those basics, you're ready to build your first project!
