...
Entities support the following pointer events which closely match the behaviour of the DOM Pointer Events API.
...
If you need to animated something every frame using a `<Script>` component is generally more performant than re-rendering the React tree, however a Script can override Entity props.

:::

You can read more about [Scripts in the docs](/docs/user-manual/scripting/index.md).
...
Now that you've learned about interactivity, you can learn about [Animations](/docs/user-manual/playcanvas-react/guide/animations) and [Physics](/docs/user-manual/playcanvas-react/guide/physics).