...
You can learn more about [loading assets](./guide/loading-assets) in the docs.
...
Now when you run it, you should be able to rotate the cube with the mouse. You can read more about [Scripts in the docs](/user-manual/scripting/).
