...
- **[useComponent](./use-component)** - Create and manage PlayCanvas components
- **[useScript](./use-script)** - Create and manage PlayCanvas scripts
...
- **[useFrame](./use-app-event#useframe)** - Register frame update callbacks (deprecated)
