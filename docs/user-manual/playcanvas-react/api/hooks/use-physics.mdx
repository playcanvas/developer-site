...
You can read more about the physics system in the [Physics guide](../guide/physics) or the [Rigidbody](/api/components/rigidbody) and [Collision](/api/components/collision) components.
