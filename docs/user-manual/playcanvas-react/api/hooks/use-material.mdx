...
The `useMaterial` hook  allows you to create and manage a PlayCanvas [StandardMaterial](https://api.playcanvas.com/engine/classes/StandardMaterial.html) instance. A material with the hook and apply it to a [`<Render/>`](../../render) component.
