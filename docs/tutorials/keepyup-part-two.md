...
description: Set up Physical materials and a cubemap for image-based lighting on the ball, ground, and backdrop.
tags: [games]
...
![Cubemap](pathname:///img/tutorials/beginner/keepyup-part-two/cubemap-preview.jpg)
...
![Football](pathname:///img/tutorials/beginner/keepyup-part-two/ball-material.jpg)
...
![Diffuse](pathname:///img/tutorials/beginner/keepyup-part-two/ball-diffuse.jpg)

The diffuse map defines the color of the surface. In this case it is the black and white pattern of the football.

### Environment

![Environment](pathname:///img/tutorials/beginner/keepyup-part-two/ball-env.jpg)
...
![Specular](pathname:///img/tutorials/beginner/keepyup-part-two/ball-spec.jpg)
...
![Normal](pathname:///img/tutorials/beginner/keepyup-part-two/ball-normal.jpg)
...
![Backdrop](pathname:///img/tutorials/beginner/keepyup-part-two/backdrop-material.jpg)

The backdrop material is much simpler, we have only one texture map.

### Emissive

![Emissive](pathname:///img/tutorials/beginner/keepyup-part-two/backdrop-emissive.jpg)
...
![Overlay](pathname:///img/tutorials/beginner/keepyup-part-two/overlay-material.jpg)
...
![Emissive](pathname:///img/tutorials/beginner/keepyup-part-two/overlay-emissive.jpg)
