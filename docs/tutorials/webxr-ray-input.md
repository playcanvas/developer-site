...
description: Point WebXR laser pointers or gaze at screen-space UI and handle clicks across desktop, mobile, and headset browsers.
tags: [vr, ar, input, ui]
...
This is a WebXR experience that provides interaction between UI and XR input source, such as: laser pointer; gaze; touch screen. Supports any device with a WebXR-capable browser, including desktop, mobile, and VR/AR headsets such as Meta Quest.
