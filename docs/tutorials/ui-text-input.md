...
![](pathname:///img/tutorials/ui-text-input/desktop-preview.gif)
...
![](pathname:///img/tutorials/ui-text-input/copy-folder.gif)

Open your project, right click in the assets panel and click on 'Paste'
![](pathname:///img/tutorials/ui-text-input/paste-folder.gif)
...
![](pathname:///img/tutorials/ui-text-input/create-image-element.gif)

Add a Script Component to the Element Entity and add the Script Type 'uiInputField'.

![](pathname:///img/tutorials/ui-text-input/add-script-component.gif)
...
![](pathname:///img/tutorials/ui-text-input/create-text-element.gif)
...
![](pathname:///img/tutorials/ui-text-input/update-script-type.gif)

Finally, launch the scene to test.

![](pathname:///img/tutorials/ui-text-input/launch-scene.gif)
