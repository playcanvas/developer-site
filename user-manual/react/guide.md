...
Now you have the basics, it's time to learn about [Interactivity](https://developer.playcanvas.com/user-manual/react/guide/interactivity.md), how to [manage assets](https://developer.playcanvas.com/user-manual/react/guide/loading-assets.md) and how to use [Physics](https://developer.playcanvas.com/user-manual/react/guide/physics.md) in your project. With those basics, you're ready to build your first project!
