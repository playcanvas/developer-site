...
* You will then have to fill out some details about your new build. The available fields are:
  ...
  * *Optimize Scene Format*: Compresses the scene JSON up to 50%. Read more [here](https://developer.playcanvas.com/user-manual/optimization/optimizing-scene-format.md).
