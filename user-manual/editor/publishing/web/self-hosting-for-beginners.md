...
We have a more [detailed page](https://developer.playcanvas.com/user-manual/editor/publishing/web/self-hosting.md) about self-hosting a PlayCanvas application. But in summary, to self-host you need to provide the three parts of the web stack described above.
