...
The first step is to download a web build of your application following the steps in [the publishing guide](https://developer.playcanvas.com/user-manual/editor/publishing/web/self-hosting.md). Then we start by making changes to the `index.html` and `__settings__.js` files in the downloaded build.
