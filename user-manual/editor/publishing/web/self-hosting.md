...
When you [publish to playcanvas.com](https://developer.playcanvas.com/user-manual/editor/publishing/web/playcanvas-hosting.md), your application is assigned a URL. To embed your application in another page. You can simply include this URL as the `src` property of an iframe.
...
* Click on the button in the left hand side toolbar or click Publishing in the top left Menu
...
As a PlayCanvas application is static content, [GitHub Pages](https://pages.github.com/) can be used to host your application using the same steps as [Self-hosting on your own server](https://developer.playcanvas.com/user-manual/editor/publishing/web/self-hosting.md#self-hosting-on-your-own-server).
