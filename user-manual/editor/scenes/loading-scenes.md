...
[Interactive demo: Switching Scenes Completely](https://playcanv.as/e/p/Q1gKd1ek/)
...
[Interactive demo: Additively Loading Scenes](https://playcanv.as/e/p/cjBInud1/)
...
If you need multiple instances of an entity hierarchy, use [Templates](https://developer.playcanvas.com/user-manual/editor/templates.md) instead. Templates generate unique GUIDs on instantiation.
:::
...
Scenes are separate from [assets](https://developer.playcanvas.com/user-manual/assets.md) and have their own properties and APIs.
...
More information about asset tags and asset loading can be found on [this page](https://developer.playcanvas.com/user-manual/assets/preloading.md).
...
[Interactive demo: Loading scenes and assets](https://playcanv.as/e/p/SBTfOAeM/)
