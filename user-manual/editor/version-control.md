...
:::ai
Before an AI assistant changes multiple scenes or assets, use the **[Editor MCP Server](https://developer.playcanvas.com/user-manual/editor/mcp-server.md)** to checkpoint a dedicated branch. Afterwards, ask it to summarize the diff and conflicts; separately approve any restore, hard reset, or branch deletion.
:::
...
More details can be found on the specific pages for [checkpoints](https://developer.playcanvas.com/user-manual/editor/version-control/checkpoints.md), [branches](https://developer.playcanvas.com/user-manual/editor/version-control/branches.md), and [merging](https://developer.playcanvas.com/user-manual/editor/version-control/merging.md).
...
- [Hard reset to a checkpoint](https://developer.playcanvas.com/user-manual/editor/version-control/checkpoints.md#hard-reset-to-a-checkpoint)
- [Deleting a branch](https://developer.playcanvas.com/user-manual/editor/version-control/branches.md#deleting-a-branch)
