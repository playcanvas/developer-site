...
| **Snap**                         | Set the increment for [gizmo](https://developer.playcanvas.com/user-manual/editor/interface/viewport.md#gizmos) snapping. Hold Shift or use the Snap toggle on the toolbar to enable snapping while using gizmos. |
...
| **Chat Notifications**           | Receive notifications for the Editor's built-in [real-time chat](https://developer.playcanvas.com/user-manual/editor/realtime-collaboration.md#real-time-chat). |
...
| **Lightmapper Auto Bake**        | Controls whether the [runtime lightmapper](https://developer.playcanvas.com/user-manual/graphics/lighting/runtime-lightmaps.md) automatically rebakes lightmaps whenever the scene is updated. |
