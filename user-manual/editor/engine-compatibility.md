...
This process will involve migration and updating of scripts given differences in our Engine API between Engine V1 and V2. All details regarding the engine changes can be found [here](https://developer.playcanvas.com/user-manual/engine/migrations.md)
...
:::ai
When behavior differs between Engine versions, use the **[Editor MCP Server](https://developer.playcanvas.com/user-manual/editor/mcp-server.md)** to reproduce the same scenario in each. An AI assistant can correlate logs and captures with affected scripts and APIs to suggest a focused fix.
:::
