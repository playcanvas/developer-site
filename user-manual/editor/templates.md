...
[Video: Templates Overview](https://www.youtube.com/embed/2HV8Ib6wYRc)
...
Also notice the different color of the label of the field that has been overridden. You can also see a more detailed list of all the overrides by clicking View Diff. See [Overrides Diff View](https://developer.playcanvas.com/user-manual/editor/templates/diff.md) for more information.
...
:::ai
Before applying overrides across template instances, ask an AI assistant through the **[Editor MCP Server](https://developer.playcanvas.com/user-manual/editor/mcp-server.md)** to summarize what will propagate. Create a checkpoint and approve only the intended changes.
:::
...
Alternatively you can open the [Override Diff View](https://developer.playcanvas.com/user-manual/editor/templates/diff.md) and apply overrides from there too.
...
Alternatively you can open the [Override Diff View](https://developer.playcanvas.com/user-manual/editor/templates/diff.md) and revert overrides from there too.
