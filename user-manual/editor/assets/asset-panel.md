...
You can also drag Assets from the Asset Panel to highlighted slots in the [Inspector](https://developer.playcanvas.com/user-manual/editor/interface/inspector.md). Slots in the Inspector will either be asset attributes of components or asset-type script attributes.

You can also drag model, material, and cubemap assets directly into the [Viewport](https://developer.playcanvas.com/user-manual/editor/interface/viewport.md)
...
- If you drag a cubemap over the background of a scene in the Viewport, the cubemap will be assigned as the skybox cubemap of the scene. This property can also be set in the [Project Settings](https://developer.playcanvas.com/user-manual/editor/interface/settings/rendering.md).
...
[Image: Pasted referenced assets]
...
[Image: Right click paste (keep folders) menu]

Will result in the following where the folder structure is preserved:

[Image: Pasted referenced assets with folders]
