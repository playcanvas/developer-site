...
Audio assets are sound files which can be played back using the [Sound Component](https://developer.playcanvas.com/user-manual/editor/scenes/components/sound.md).
