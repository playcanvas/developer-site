...
[Interactive demo: Cubemap](https://playcanv.as/b/xp7v1oFB/)
...
This technique allows you to use Environment Map such as CubeMap in order to simulate physically based ambient light and reflection on materials. [Read more](https://developer.playcanvas.com/user-manual/graphics/physical-rendering/image-based-lighting.md) on how it works and how to author CubeMaps for IBL.
