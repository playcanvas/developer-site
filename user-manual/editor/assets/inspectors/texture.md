...
A texture is an image that can be assigned to a [material](https://developer.playcanvas.com/user-manual/editor/assets/inspectors/material.md) and then applied to a graphical primitive.
