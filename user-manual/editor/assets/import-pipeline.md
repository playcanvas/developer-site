...
Newly created assets will automatically be set to [preload](https://developer.playcanvas.com/user-manual/assets/preloading.md) or not depending on whether this option is enabled or not. The exception to this are JavaScript script files which will always be set to preloaded when created.
...
Only available if using [Convert to GLB](https://developer.playcanvas.com/user-manual/editor/assets/import-pipeline.md#convert-to-glb) option. When a model file is imported, a template asset is created that contains the full hierarchy of the model as entities allowing you to manipulate them directly in the Editor. See more information about this feature [here](https://developer.playcanvas.com/user-manual/editor/assets/import-pipeline/import-hierarchy.md).
...
Please refer to the [Animation section](https://developer.playcanvas.com/user-manual/editor/assets/inspectors/animation.md) for more details.
