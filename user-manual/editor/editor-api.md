...
Below we have an example where a button has been added to the [Viewport](https://developer.playcanvas.com/user-manual/editor/interface/viewport.md) to generate and randomly place boxes into the scene.
