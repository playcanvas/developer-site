...
You can open the Code Editor from inside the [PlayCanvas Editor](https://developer.playcanvas.com/user-manual/editor.md) by pressing Ctrl + I. You can also click on this toolbar icon:
...
:::ai
For changes spanning related text assets, use an AI coding assistant through **[VS Code Extension Pull/Push mode](https://developer.playcanvas.com/user-manual/editor/scripting/vscode-extension.md)** to trace and update producers and listeners together, then review the complete diff before syncing.
:::
