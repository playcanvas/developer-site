...
Upgrade to the paid **Organization plan** when your team needs **private projects**, more storage (50 GB), and per-seat billing on a single invoice. Seats cost $50 each per month, can be added or removed at any time, and are prorated on your next billing date — see the [worked example](https://developer.playcanvas.com/user-manual/account-management/billing.md#how-is-billing-for-organization-accounts-calculated) in the Billing FAQ, and the [pricing page](https://playcanvas.com/plans) for the latest details.
...
1. [Create an Organization](https://developer.playcanvas.com/user-manual/account-management/organizations/creating.md) — start a new Organization or convert an existing account.
2. [Manage your Organization](https://developer.playcanvas.com/user-manual/account-management/organizations/managing.md) — handle [roles and permissions](https://developer.playcanvas.com/user-manual/account-management/organizations/managing.md#permissions), [seats](https://developer.playcanvas.com/user-manual/account-management/organizations/managing.md#seats), and [projects](https://developer.playcanvas.com/user-manual/account-management/organizations/managing.md#projects).
