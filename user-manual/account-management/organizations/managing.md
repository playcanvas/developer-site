...
If you're subscribed to the Organization plan, you can increase or decrease the number of seats at any time. Seat changes are prorated on your next billing date — see the [worked example](https://developer.playcanvas.com/user-manual/account-management/billing.md#how-is-billing-for-organization-accounts-calculated) in the Billing FAQ.
