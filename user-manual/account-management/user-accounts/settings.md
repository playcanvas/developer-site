...
See the [API Documentation](https://developer.playcanvas.com/user-manual/api.md) for details on using API tokens.
...
Transform your personal account into an [organization](https://developer.playcanvas.com/user-manual/account-management/organizations.md) account:
...
For billing-specific questions and detailed subscription management, see [Billing](https://developer.playcanvas.com/user-manual/account-management/billing.md).
