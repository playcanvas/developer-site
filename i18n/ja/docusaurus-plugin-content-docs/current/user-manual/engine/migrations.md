---
title: エンジンマイグレーション
description: 各メジャーPlayCanvas Engineリリースの破壊的変更とマイグレーション手順です。
---

:::ai

* **[Engine Development](/user-manual/ai/developing-with-engine/):** インストール済みの PlayCanvas を更新し、対象バージョンで削除された API を置き換え、デバッグ版 Engine で実行して、非推奨、シェーダー、レンダリングのエラーを確認してください。
