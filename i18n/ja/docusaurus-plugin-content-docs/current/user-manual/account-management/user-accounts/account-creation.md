...
![サインアップ](pathname:///img/user-manual/account-management/user-accounts/sign-up.png)
...
![サインアップフォーム](pathname:///img/user-manual/account-management/user-accounts/sign-up-form.png)

ユーザー名とパスワードのオプションを選択した場合、メールアドレスの確認が求められます。

![メールアドレスの確認](pathname:///img/user-manual/account-management/user-accounts/sign-up-confirm-email.png)

受信トレイに移動し、確認リンクをクリックしてください。このページに移動します。

![メールアドレス確認済み](pathname:///img/user-manual/account-management/user-accounts/sign-up-email-verified.png)

続行すると、あなたの詳細情報を追加するように求められます。

![詳細フォーム](pathname:///img/user-manual/account-management/user-accounts/sign-up-details-form.png)
...
![ロールボール](pathname:///img/user-manual/account-management/user-accounts/sign-up-roll-ball.png)
