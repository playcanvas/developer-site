---
title: オープンソースのミッション
description: GitHub上のPlayCanvasオープンソースプロジェクトと、コード貢献、バグ報告、コミュニティ支援の方法です。
---
...
| [**supersplat**](https://github.com/playcanvas/supersplat) | SuperSplat Editor — 3Dガウシアンスプラットのためのブラウザベースエディタ | MIT |
| [**supersplat-viewer**](https://github.com/playcanvas/supersplat-viewer) | SuperSplat Viewer — 公開済みスプラットのオープンソースビューア。npm経由で埋め込み可能 | MIT |
| [**splat-transform**](https://github.com/playcanvas/splat-transform) | スプラットの変換・トランスフォーム・解析のためのCLIとライブラリ | MIT |
...
| [**font-tools**](https://github.com/playcanvas/font-tools) | テキスト要素向けのMSDF Fontアセット生成ツール（ウェブアプリ、CLI、ライブラリ） | MIT |
