...
ブラックリストされたカードは[こちら](https://www.khronos.org/webgl/wiki/BlacklistsAndWhitelists)で確認できます。

ソフトウェアレンダラを使用しているかどうかを確認するには、[WebGL Report](https://webglreport.com/)を訪問してください。Chromeがソフトウェアレンダラを使用している場合、**Unmasked Renderer**の行に**SwiftShader**が報告されていることがわかります。
