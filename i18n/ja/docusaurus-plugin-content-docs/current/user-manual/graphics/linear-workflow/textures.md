---
title: テクスチャ
description: Asset とコードでカラーテクスチャを sRGB としてマークし（プロシージャルなターゲットも含む）、サンプリングを物理的に正しく保ちます。
---

:::ai

- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** 「テクスチャ」向けに Material アセットとシーンのレンダリング設定を構成し、起動して表示結果をキャプチャできます。
