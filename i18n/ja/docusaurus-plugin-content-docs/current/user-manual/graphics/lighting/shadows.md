...
PCSS の見た目とコストは、以下のプロパティで微調整できます。
...
ライトのシャドウタイプが PCSS の場合、**Penumbra Size** と **Penumbra Falloff** が [Lightコンポーネント](/user-manual/editor/scenes/components/light) に表示されます。サンプル数はスクリプトから設定します。
