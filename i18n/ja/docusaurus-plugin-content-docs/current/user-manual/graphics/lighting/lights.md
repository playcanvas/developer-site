...
* **[Engine Development](/user-manual/ai/developing-with-engine/):** 「ライト」について、次の要件を満たしてください: Editor における Directional、omni、spot ライト：ギズモ、シャドウ、cookies、実践的なライティングの組み合わせ アプリケーションを起動して表示結果をキャプチャし、シェーダーまたはレンダリングのコンソールエラーを確認してください。
* **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** 開いているプロジェクトで「ライト」を設定し、次の要件を満たしてください: Editor における Directional、omni、spot ライト：ギズモ、シャドウ、cookies、実践的なライティングの組み合わせ。シーンを起動して表示結果をキャプチャし、シェーダーまたはレンダリングのコンソールエラーを確認してください。
