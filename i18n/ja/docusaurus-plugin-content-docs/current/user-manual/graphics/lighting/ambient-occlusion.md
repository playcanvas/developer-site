...
description: DCCツールでアンビエントオクルージョンテクスチャをベイクしアップロードし、拡散とスペキュラのアンビエントライティングに乗算します。
---
...
![Ambient Occlusion comparison: without/with](pathname:///img/user-manual/graphics/lighting/lightmapping/model-ao-comparison.jpg)  
...
![3D's Max: Ambient Occlusion VRay Material](pathname:///img/user-manual/graphics/lighting/lightmapping/3ds-max-ao-rendering.png)
...
![3D's Max VRay Render Settings: Override mtl](pathname:///img/user-manual/graphics/lighting/lightmapping/3ds-max-vray-override-mtl.png)
...
![Editor Ambient Occlusion Map](pathname:///img/user-manual/graphics/lighting/lightmapping/editor-ao-map.png)
