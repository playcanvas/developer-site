...
- **[Engine Development](/user-manual/ai/developing-with-engine/):** 「アンビエントオクルージョン(AO)」について、次の要件を満たしてください: DCCツールでアンビエントオクルージョンテクスチャをベイクしアップロードし、拡散とスペキュラのアンビエントライティングに乗算すること アプリケーションを起動して表示結果をキャプチャし、シェーダーまたはレンダリングのコンソールエラーを確認してください。
- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** 開いているプロジェクトで「アンビエントオクルージョン(AO)」を設定し、次の要件を満たしてください: DCCツールでアンビエントオクルージョンテクスチャをベイクしアップロードし、拡散とスペキュラのアンビエントライティングに乗算すること。シーンを起動して表示結果をキャプチャし、シェーダーまたはレンダリングのコンソールエラーを確認してください。
