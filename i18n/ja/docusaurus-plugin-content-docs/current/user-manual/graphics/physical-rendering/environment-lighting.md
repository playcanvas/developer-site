...
Engine v2.23 より前は、通常のキューブマップを持つマテリアルはシーンのスカイボックスからアンビエントライトを取得していました。v2.23 からは、上記のとおりマテリアルの環境はオール・オア・ナッシングとなり、そのようなマテリアルは Ambient Color を使用します。イメージベースのアンビエントライトを取り戻すには、キューブマップをプリフィルタしてください。
