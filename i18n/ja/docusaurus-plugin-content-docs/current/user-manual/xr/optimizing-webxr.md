...
- **[Engine Development](/user-manual/ai/developing-with-engine/):** 「WebXRアプリケーションの最適化」について、次の要件を満たしてください: WebXRのパフォーマンス指針: フレームレート、ステレオレンダリングのコスト、ドローコール、バッチング、ライトマップ、モバイルARトラッキングのオーバーヘッドであること 対応する XR セッションで実行し、記載された操作を試して、ランタイムログと観察結果を報告してください。
