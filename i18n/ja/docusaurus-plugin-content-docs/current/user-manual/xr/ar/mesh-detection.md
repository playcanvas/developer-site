---
title: メッシュ検出
description: "AR向け実世界メッシュ検出: セマンティックメッシュ、変換、物理とオクルージョンの利用、メッシュジオメトリ向けのPlayCanvas APIです。"
---

:::ai

* **[Engine Development](/user-manual/ai/developing-with-engine/):** 「メッシュ検出」について、次の要件を満たしてください: AR向け実世界メッシュ検出: セマンティックメッシュ、変換、物理とオクルージョンの利用、メッシュジオメトリ向けのPlayCanvas APIであること 対応する XR セッションで実行し、記載された操作を試して、ランタイムログと観察結果を報告してください。
