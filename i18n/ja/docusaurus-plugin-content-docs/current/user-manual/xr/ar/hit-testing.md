---
title: ヒットテスティング
description: "PlayCanvasでのARヒットテスト: 実世界ジオメトリとのレイ交差、信頼性、Sceneに整合する仮想オブジェクトの配置です。"
---

:::ai

- **[Engine Development](/user-manual/ai/developing-with-engine/):** 「ヒットテスティング」について、次の要件を満たしてください: PlayCanvasでのARヒットテスト: 実世界ジオメトリとのレイ交差、信頼性、Sceneに整合する仮想オブジェクトの配置であること 対応する XR セッションで実行し、記載された操作を試して、ランタイムログと観察結果を報告してください。
