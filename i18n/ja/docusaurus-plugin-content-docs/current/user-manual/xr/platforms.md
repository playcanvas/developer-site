---
title: プラットフォーム
description: WebXRのハードウェアとブラウザ要件。Quest、モバイル、PCVR、Vision ProでのVR、AR、機能の検証済みプラットフォーム表です。
---

:::ai

- **[Engine Development](/user-manual/ai/developing-with-engine/):** 対象の VR または AR プラットフォームを選択し、必要なブラウザーと対応 WebXR モジュールを確認して、実機で検証した機能マトリクスを記録してください。
