...
- **[Engine Development](/user-manual/ai/developing-with-engine/):** 「Animイベント」について、次の要件を満たしてください: 特定のフレームで名前付きアニメーションイベントを発火し、Scriptのanimコンポーネントから処理すること シーンを起動し、再生、遷移、パラメーター、イベントデータを確認してください。
- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** GLB アニメーションアセットのイベントを確認、追加、更新、削除してください。
...
![Animation Asset With Event](/img/user-manual/animation/animation-asset-with-events.png)
