...
- **[Engine Development](/user-manual/ai/developing-with-engine/):** 「Animstategraphアセット」について、次の要件を満たしてください: アニメーション状態、トランジション、ブレンド、レイヤー、パラメーターのanimstategraphステートマシンを作成すること シーンを起動し、再生、遷移、パラメーター、イベントデータを確認してください。
- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** アニメーショングラフのレイヤー、ステート、トランジション、条件、パラメーターを確認して変更してください。
