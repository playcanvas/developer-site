...
title: PLY フォーマット
sidebar_label: PLY
description: "3D Gaussian splats向けPLY形式：ヘッダー構成、頂点プロパティ、バイナリとASCII、学習ツールがスプラットフィールドをどうエンコードするかです。"
---
...
- **エディタ**：[SuperSplat Editor](/user-manual/supersplat/editor/)
- **コンバーター**：[SplatTransform](/user-manual/splat-transform/)、[SuperSplat Convert](/user-manual/supersplat/convert)
- **ビューア**：[SuperSplat Viewer](/user-manual/supersplat/viewer/)、[Model Viewer](https://github.com/playcanvas/model-viewer)
...
[SplatTransform](/user-manual/splat-transform/) ツールを使用して、PLY をより効率的なランタイムフォーマットに変換してください。現在、最高の圧縮率と最速のロード時間を実現するために、Self-Organizing Gaussians（別名 SOGS）をお勧めしています。
