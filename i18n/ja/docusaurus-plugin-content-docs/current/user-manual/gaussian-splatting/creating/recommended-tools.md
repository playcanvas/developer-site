...
| [**Lichtfeld Studio**](https://lichtfeld.io/) | 中級 | Win, Linux | 無料 | ✔️ | カメラポーズ + トレーニング | CUDA GPU |
...
3D Gaussian Splatsをトレーニング、編集、レンダリングするための無料かつオープンソースのデスクトップアプリケーションです。変形、クロップ、選択ツールを含む編集スイートを備えています。トレーニング用のCOLMAPベースのデータセットをサポートし、PLY形式でエクスポートできます。CUDA 12.8+搭載のNVIDIA GPUが必要です。
