---
title: プロジェクト
description: 作成からダッシュボード、設定、チームワーク、Dev Logs、エクスポート、所有権譲渡までのプロジェクト管理トピックの一覧です。
---
...
- **[プロジェクトのダウンロード](downloading)** - アプリパッケージをダウンロードし、staticまたはnpmのパッケージ形式を選択します。

### 高度な管理

- **[バックアップとエクスポート](backup-and-export)** - バックアップとエクスポートでプロジェクトを保護します。
