---
title: プロジェクト設定
description: ブランディング、アートワーク、公開範囲、説明、ドメインなど、プロジェクトの見え方と挙動を制御するメタデータを調整します。
---

プロジェクト設定では、基本的な情報、プライバシー設定、ブランディングオプションなど、プロジェクトのさまざまな側面を設定できます。

![プロジェクト設定](pathname:///img/user-manual/editor/projects/project-settings.png)
...
<!--
![プロジェクト画像設定](pathname:///img/user-manual/dashboard/project-image.png)
-->
