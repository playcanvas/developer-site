...
* **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** ソースファイルをアップロードし、既存のアセットを再インポートし、ソースまたは処理済みファイルをダウンロードしてください。 変更後のアセットメタデータ、レジストリの状態、参照を確認してください。
...
'Asset Import' を開き、 'Convert to GLB' をチェックしてください。
