---
title: Text
description: Text Asset はダイアログや設定などのプレーンテキストを保持します。Inspector は読み取り専用の内容プレビューを表示し、専用プロパティはありません。
---

:::ai

- **[VS Code Extension](/user-manual/ai/vscode-extension/):** Text アセットファイルを Pull/Push モードでローカル編集し、同期前に差分を確認してください。
- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** Text アセットのテキストを読み取りまたは上書きし、メタデータを更新して、プロジェクトを起動して結果を確認してください。
