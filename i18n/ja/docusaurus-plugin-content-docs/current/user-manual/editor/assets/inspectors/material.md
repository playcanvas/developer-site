---
title: Material
description: マテリアル Inspector のリファレンス。折りたたみセクションで、テクスチャの変換からライティング応答マップ、レンダリングパラメータまで PBR 設定を扱います。
---

:::ai

- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** マテリアルの色とプロパティを編集し、ビューポートまたは実行中のアプリをキャプチャして結果を確認してください。
