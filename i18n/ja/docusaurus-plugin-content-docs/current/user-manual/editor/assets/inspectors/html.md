---
title: HTML
description: HTML Asset は Editor から編集できるページまたは部分のマークアップを保持します。Inspector は読み取り専用の整形プレビューを表示し、追加プロパティはありません。
---

:::ai

- **[VS Code Extension](/user-manual/ai/vscode-extension/):** HTML アセットファイルを Pull/Push モードでローカル編集し、同期前に差分を確認できます。
- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** HTML アセットのテキストを読み取りまたは上書きし、メタデータを更新して、プロジェクトを起動して結果を確認できます。
