---
title: CSS
description: CSS Asset は Editor から編集できるスタイルシートコードを保持します。Inspector は読み取り専用のプレビューを表示し、追加の設定項目はありません。
---

:::ai

- **[VS Code Extension](/user-manual/ai/vscode-extension/):** CSS アセットファイルを Pull/Push モードでローカル編集し、同期前に差分を確認してください。
- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** CSS アセットのテキストを読み取りまたは上書きし、メタデータを更新して、プロジェクトを起動して結果を確認してください。
