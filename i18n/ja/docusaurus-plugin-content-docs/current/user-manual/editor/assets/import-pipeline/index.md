...
* **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** アセットを再インポートし、UV1 座標をアンラップし、テクスチャを変換し、アトラス、キューブマップ、スプライト、バンドルを生成してください。 変更後のアセットメタデータ、レジストリの状態、参照を確認してください。
