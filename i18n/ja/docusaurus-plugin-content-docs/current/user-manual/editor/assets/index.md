...
- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** アセットを一覧表示、作成、削除し、マテリアルのプロパティを編集し、テンプレートをインスタンス化し、Asset Store からアセットをインポートしてください。 変更後のアセットメタデータ、レジストリの状態、参照を確認してください。
