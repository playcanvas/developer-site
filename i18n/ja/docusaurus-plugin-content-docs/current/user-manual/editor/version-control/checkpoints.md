...
- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** バージョン管理の状態を確認し、依頼されたチェックポイントを作成または比較して、変更後のプロジェクト履歴を確認してください。後続のチェックポイントを復元できなくなる可能性があるため、明示的な依頼なしに復元や hard reset を行わないでください。
