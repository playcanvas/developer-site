---
title: チェックポイント
description: 永続スナップショットの作成、復元、ハードリセットを行い、グラフへの影響とハードリセット後に元に戻せないものを説明します。
---
...
![Checkpoint](pathname:///img/user-manual/editor/version-control/checkpoint.jpg)
...
![VC Panel](pathname:///img/user-manual/editor/version-control/vc-panel.jpg)

New Checkpointボタンをクリックすると、チェックポイントを作成するための入力フォームが開きます。また、キーボードショートカット Ctrl + S (OS Xの場合、Cmd + S) を使用することもできます。

![Create Checkpoint](pathname:///img/user-manual/editor/version-control/create-checkpoint.jpg)

## チェックポイントの復元 {#restoring-a-checkpoint}

![Restore Checkpoint](pathname:///img/user-manual/editor/version-control/restore-checkpoint.jpg)
...
![Restore checkpoint applied](pathname:///img/user-manual/editor/version-control/restore-checkpoint-applied.png)
...
![](pathname:///img/user-manual/editor/version-control/hard-reset.png)

テキストボックスに 'hard reset' と入力して、選択したチェックポイント以降のすべてのチェックポイントを削除することを確認します。

![](pathname:///img/user-manual/editor/version-control/hard-reset-confirm.png)
