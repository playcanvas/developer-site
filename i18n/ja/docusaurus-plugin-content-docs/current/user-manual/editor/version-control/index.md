---
title: バージョン管理
description: PlayCanvasのチェックポイント、ブランチ、マージ、ストレージ利用を、馴染みのGitの概念と組み込みのコラボレーションワークフローに結びつけます。
---
...
:::ai
AIアシスタントが複数のシーンやアセットを変更する前に、**[Editor MCP Server](/user-manual/editor/mcp-server/)**で専用ブランチにチェックポイントを作成します。変更後は差分と競合を要約させ、復元、ハードリセット、ブランチ削除は個別に承認します。
:::
