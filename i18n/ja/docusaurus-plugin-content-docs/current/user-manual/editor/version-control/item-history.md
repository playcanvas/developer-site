---
title: プロジェクト内の履歴管理
description: Item Historyのロールアウト日以降に編集されたアイテムについて、Entity、アセット、Scene、設定ごとのチェックポイントのタイムラインを表示します。
---

:::ai

- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** チェックポイントの詳細を確認、比較して、エンティティ、アセット、設定が変更された時点を追跡してください。
