---
title: View Changes
description: マージ前、チェックポイント、またはアイドルレビューで、活動中ブランチの状態とチェックポイント間の読み取り専用 diff を開きます。
---

:::ai

- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** バージョン管理の状態を確認し、チェックポイントを比較して 2 つの保存状態間のプロジェクト変更を特定してください。
...
![View Changes](/img/user-manual/editor/version-control/view-changes.jpg)

変更内容は、編集できない観覧専用のインターフェースである、マージ時に使用されるConflict Manager(競合マネージャー)と似たインターフェースで表示されます。

![View Changes Dialog](/img/user-manual/editor/version-control/view-changes-dialog.jpg)
