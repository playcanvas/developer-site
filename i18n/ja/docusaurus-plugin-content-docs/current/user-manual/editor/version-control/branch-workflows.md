...
description: PlayCanvas のバージョン管理を使うチーム向けに、フィーチャーブランチ、リリーストレイン、staging から本番までのよくあるパターンを示します。
---

:::ai

- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** 状態を確認し、ブランチの一覧表示、作成、切り替え、チェックポイント作成、対応するマージワークフローを実行してください。
