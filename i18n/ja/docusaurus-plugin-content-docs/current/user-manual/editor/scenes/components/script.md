...
- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** Script Component の追加、解析済みスクリプトアセットのアタッチ、属性の設定を行えます。
- **[VS Code Extension](/user-manual/ai/vscode-extension/):** Editor へアタッチする前にスクリプトファイルをローカル編集できます。
