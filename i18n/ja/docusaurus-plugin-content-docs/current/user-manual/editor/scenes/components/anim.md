...
- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** Animをエンティティへ追加または削除し、プロパティを設定して、シーンの起動やキャプチャで確認してください。
...
- [アニメーション](/user-manual/animation) - アニメーションシステムについて詳しく学ぶ
