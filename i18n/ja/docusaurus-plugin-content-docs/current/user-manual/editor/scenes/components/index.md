---
title: コンポーネント
description: レンダリング、物理、オーディオ、UI、Script など、Scene に挙動を追加する PlayCanvas の Entity Component を紹介します。
---

:::ai

- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** エンティティのコンポーネントを追加、削除、設定し、ビューポートのキャプチャやシーンの起動で結果の動作を検証してください。
...
| アクションメニュー | 省略記号 (⋯) アイコンをクリックして、コピー、貼り付け、削除のオプションにアクセスします。 |
