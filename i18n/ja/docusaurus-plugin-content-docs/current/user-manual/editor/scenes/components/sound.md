...
[Scriptコンポーネント](/user-manual/editor/scenes/components/script)を使用してSoundコンポーネントのプロパティを制御できます。Soundコンポーネントのスクリプトインターフェースは[こちら](https://api.playcanvas.com/engine/classes/SoundComponent.html)です。
