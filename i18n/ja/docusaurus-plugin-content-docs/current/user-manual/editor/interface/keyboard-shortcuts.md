---
title: キーボードショートカット
description: Editor のマウスによるカメラ操作、ビューポートの修飾キー、起動、複製、変換ギズモ、選択のフレーム、削除などよく使うショートカットです。
---
...
| エンティティ / アセットの貼り付け  | コピーしたエンティティ/アセットを現在選択されているエンティティ/フォルダの下に貼り付けます。 | CTRL + V                       |
...
| ベイク                  | [ランタイムライトマッパー](/user-manual/graphics/lighting/runtime-lightmaps) を使用してライティングを再構築します。                 | CTRL + B                       |
