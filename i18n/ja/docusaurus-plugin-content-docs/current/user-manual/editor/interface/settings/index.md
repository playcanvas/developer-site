---
title: プロジェクト設定
description: Project Settings のマップ。Engine、インポート、物理、レンダリング、ライトマップ、バッチ、起動、ローカライゼーション、ネットワーク、レイヤーに加え、歯車から開く個人用 Editor パネルを扱います。
---

:::ai

- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** 物理、レンダリング、レイヤー、ローディング、入力、解像度などのプロジェクト設定を確認して変更してください。
