...
description: 個人用の Editor 設定パネル。グリッド、スナップ、ズーム、グラブ、パス、プレビュークリップ、ガンマ、トーンマップ、フォグ、アイコン、ロケール、チャット、アラート、複製、ライトマッパーの自動再ベイクを扱います。
---

:::ai

- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** 個人用の Editor 設定を `user`、`projectUser`、`session` スコープで読み取り、変更してから再度確認し、結果が視覚的な場合はビューポートをキャプチャーします。
