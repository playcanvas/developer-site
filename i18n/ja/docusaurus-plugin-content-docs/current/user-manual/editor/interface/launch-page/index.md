...
![起動ボタン](pathname:///img/user-manual/editor/launch-page/launch-button.png)
...
![起動ページを並べて表示](pathname:///img/user-manual/editor/launch-page/launch-page-side-by-side.png)
...
![起動ページのライブリンク](pathname:///img/user-manual/editor/launch-page/launch-page-live-link.gif)
