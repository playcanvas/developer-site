...
エンティティが複数のコンポーネントを持つ場合、表示されるアイコンは次の優先順位に従います: camera、light、audio listener、audio source、sound、particle system、script、animation。また、ライトのアイコンはライトの色に合わせて着色されます。
