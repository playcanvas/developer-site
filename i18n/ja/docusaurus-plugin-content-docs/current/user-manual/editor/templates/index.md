---
title: テンプレート
description: Editor で再利用可能な Entity プレハブ向けに、テンプレート作成、インスタンス、オーバーライド、変更の適用、インスタンスの切り離しを扱います。
---
...
![Template Instance](pathname:///img/user-manual/editor/templates/hierarchy.png)
...
![Template Inspector](pathname:///img/user-manual/editor/templates/inspector.png)
...
![Overrides](pathname:///img/user-manual/editor/templates/override.png)
...
![Override Hover](pathname:///img/user-manual/editor/templates/override-hover.png)
