...
description: テンプレート内にテンプレートを組み合わせる方法と、階層の異なるレベルで変更を適用したときのオーバーライドの伝播を説明します。
---

:::ai

- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** ネストされた Template アセットをインスタンス化し、インスタンスのオーバーライドを確認、適用、元に戻す、またはリンク解除してください。
