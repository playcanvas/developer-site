---
title: モバイル
description: Cordova、GoNative、またはローカルのフルスクリーン WebView を使って、PlayCanvas の Web ゲームをストア向けネイティブアプリにラップする方法を紹介します。
---

:::ai

* **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** 「モバイル」向けのビルドを一覧表示、確認、公開し、static または npm のダウンロードビルドを生成して保存してください。
