...
[Cube Jumpプロジェクト](https://playcanvas.com/project/354998/overview/cube-jump-playable-ad-for-fb)は、Facebook Playable Adフォーマットにエクスポートする準備ができており、[HTML出力の期待される結果はこちら](/downloads/fb-playable-ad-cube-jump-html.zip)にあります。
