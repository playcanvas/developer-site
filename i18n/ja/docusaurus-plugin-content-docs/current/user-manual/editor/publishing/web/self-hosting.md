---
title: セルフホスティング
description: iframe でホスト済みビルドを埋め込む方法、または zip をダウンロードして自前の Web サーバーに静的ファイルをデプロイする方法を示します。
---
...
![Download](pathname:///img/user-manual/editor/publishing/dialog-publish-download.png)
