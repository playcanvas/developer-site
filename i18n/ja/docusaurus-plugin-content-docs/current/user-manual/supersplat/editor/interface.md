...
この縦型のツールバーには、スプラットの視覚化、カメラコントロール、およびアプリケーション設定に関連するアイコンが含まれています。歯車アイコンをクリックすると**設定**パネルが開きます。このパネルには、表示やレンダリングのコントロール（色、トーンマッピング、視野角、グリッドやバウンディングボックスのオーバーレイなど）と[言語](#言語)設定が含まれています。
