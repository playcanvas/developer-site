...
[シーンページ](/user-manual/supersplat/scene-page)では、オープンソースの[SuperSplat Viewer](/user-manual/supersplat/viewer/)が、訪問者がシーンを開いたときにトラックを自動再生し、トラックのループモードに従ってループします — スプラットを手放しのシネマティックなフライスルーに変えます。
