...
<div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: '20px', margin: '24px 0 40px' }}>
  ...
  <a className="card padding--md shadow--md" href="/user-manual/react/examples/text" style={{ color: 'inherit', textDecoration: 'none' }}>
    <div style={{ fontWeight: 700, fontSize: '1.1rem', marginBottom: '6px' }}>テキスト</div>
    <div style={{ opacity: 0.8 }}>Screen とテキスト Element を使い、font-tools の MSDF フォントで画面空間の UI テキストを表示します。</div>
  </a>
</div>
