...
- **[Engine Development](/user-manual/ai/developing-with-engine/):** 「カスタムアセットパーサー」について、次の要件を満たしてください: エンジンのリソースハンドラーにカスタムファイルフォーマットのパーサーを登録し、新しいアセットフォーマットの読み込みや組み込みパーサーの上書きを行います 変更後のアセットメタデータ、レジストリの状態、参照を確認してください。
- **[VS Code Extension](/user-manual/ai/vscode-extension/):** 関連するアセット管理スクリプトに「カスタムアセットパーサー」を実装し、次の要件を満たしてください: エンジンのリソースハンドラーにカスタムファイルフォーマットのパーサーを登録し、新しいアセットフォーマットの読み込みや組み込みパーサーの上書きを行います。Push の前に完全な差分と診断を確認してください。
- **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** 「カスタムアセットパーサー」に必要なスクリプトを作成してアタッチし、次の要件を満たしてください: エンジンのリソースハンドラーにカスタムファイルフォーマットのパーサーを登録し、新しいアセットフォーマットの読み込みや組み込みパーサーの上書きを行います。シーンを起動して、Asset Registry の状態、参照、ランタイムログを確認してください。
