...
上記のリストはエンジンの組み込みローダーを対象としていますが、固定ではありません。ランタイムでカスタムパーサーを使用すると、ほとんどのアセットタイプで新しいファイルフォーマットのサポートを追加したり、組み込みのものを上書きしたりできます。[カスタムアセットパーサー](custom-parsers)を参照してください。

## 関連項目

- [モデル](models/index.md) - PlayCanvas 用の 3D モデルの準備
- [アセットインスペクター](/user-manual/editor/assets/inspectors/) - エディタでアセットプロパティを設定
- [カスタムアセットパーサー](custom-parsers) - ランタイムでカスタムファイルフォーマットを読み込む
