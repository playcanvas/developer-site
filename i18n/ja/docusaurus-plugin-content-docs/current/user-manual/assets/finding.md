...
description: PlayCanvas プロジェクトで使える 3D モデル、テクスチャ、効果音、音楽の無料および有料の入手先です。
---

:::ai

* **[Editor MCP Server](/user-manual/ai/editor-mcp-server/):** 外部サイトで選択したアセットをアップロードし、インポートされたアセットタイプと生成ファイルを確認して、使用前にプロジェクト内の参照を確認してください。
