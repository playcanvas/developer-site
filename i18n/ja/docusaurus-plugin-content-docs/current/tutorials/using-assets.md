...
[Aモデル](/downloads/tutorials/A.dae)、[Bモデル](/downloads/tutorials/B.dae)、[Cモデル](/downloads/tutorials/C.dae)をダウンロードし、プロジェクトにアップロードしてください。ファイル名がA.dae、B.dae、C.daeになっていることを確認してください。アセット名に影響を与えるためです。
