...
description: マテリアルの不透明度をアニメーションし、ジオメトリやマテリアルを複製せずに個別モデルのフェードイン・アウトを行います。
---
...
<Link to='https://playcanvas.com/project/436566/'>プロジェクトを開く ↗</Link>
