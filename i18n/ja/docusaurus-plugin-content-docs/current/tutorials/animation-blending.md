...
description: 旧 Model と Animation のチュートリアルです。キャラクターサイクル間の滑らかな遷移には Anim State Graph のブレンドを推奨します。
---
...
![Animated Entity](pathname:///img/tutorials/animation_blending.jpg)
