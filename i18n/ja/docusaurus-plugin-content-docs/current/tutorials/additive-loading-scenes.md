...
description: 現在の Scene に別 Scene を加算的に読み込み、ハブやストリーミングレベルをワールド全体の差し替えなしで重ねます。
---

import Link from '@docusaurus/Link';

シーンの読み込みに関する完全なドキュメントは、[ユーザーマニュアル](/user-manual/editor/scenes/loading-scenes/)にあります。
...
<Link to='https://playcanvas.com/project/685077/'>プロジェクトを開く ↗</Link>
