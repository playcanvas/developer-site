...
title: ファイルの取り扱い
sidebar_position: 5
description: Shader Editor がプロジェクトをブラウザの IndexedDB に保存する方法と、生成されたランタイムシェーダーコード付き Shader Pack の保存・読み込み・エクスポートです。
---
...
プロジェクトはローカルのハードドライブに保存して、後で読み込むことができます。これについての詳細は、[インスペクターパネル](/shader-editor/window-layout/inspector-pane)のドキュメントを参照してください。
...
これを実現する方法についての詳細は、[インスペクターパネル](/shader-editor/window-layout/inspector-pane)のドキュメントを参照してください。
